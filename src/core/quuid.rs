...
extern {
  ...
  fn C_ZN5QUuidC2ERK7QString(arg0: *mut c_void) -> u64;
  // proto:  QByteArray QUuid::toRfc4122();
  fn C_ZNK5QUuid9toRfc4122Ev(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  QString QUuid::toString();
  fn C_ZNK5QUuid8toStringEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  bool QUuid::isNull();
  fn C_ZNK5QUuid6isNullEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto: static QUuid QUuid::createUuidV5(const QUuid & ns, const QString & baseData);
  fn C_ZN5QUuid12createUuidV5ERKS_RK7QString(arg0: *mut c_void, arg1: *mut c_void) -> *mut c_void;
  // proto: static QUuid QUuid::createUuid();
  fn C_ZN5QUuid10createUuidEv() -> *mut c_void;
  ...
  fn C_ZN5QUuidC2Ejtthhhhhhhh(arg0: c_uint, arg1: c_ushort, arg2: c_ushort, arg3: c_uchar, arg4: c_uchar, arg5: c_uchar, arg6: c_uchar, arg7: c_uchar, arg8: c_uchar, arg9: c_uchar, arg10: c_uchar) -> u64;
  // proto:  void QUuid::QUuid(const QByteArray & );
  fn C_ZN5QUuidC2ERK10QByteArray(arg0: *mut c_void) -> u64;
  // proto: static QUuid QUuid::createUuidV3(const QUuid & ns, const QString & baseData);
  fn C_ZN5QUuid12createUuidV3ERKS_RK7QString(arg0: *mut c_void, arg1: *mut c_void) -> *mut c_void;
  // proto:  void QUuid::QUuid();
  fn C_ZN5QUuidC2Ev() -> u64;
  // proto:  QByteArray QUuid::toByteArray();
  fn C_ZNK5QUuid11toByteArrayEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  void QUuid::QUuid(const char * );
  fn C_ZN5QUuidC2EPKc(arg0: *mut c_char) -> u64;
  // proto: static QUuid QUuid::createUuidV5(const QUuid & ns, const QByteArray & baseData);
  fn C_ZN5QUuid12createUuidV5ERKS_RK10QByteArray(arg0: *mut c_void, arg1: *mut c_void) -> *mut c_void;
  // proto: static QUuid QUuid::fromRfc4122(const QByteArray & );
  fn C_ZN5QUuid11fromRfc4122ERK10QByteArray(arg0: *mut c_void) -> *mut c_void;
  // proto: static QUuid QUuid::createUuidV3(const QUuid & ns, const QByteArray & baseData);
  fn C_ZN5QUuid12createUuidV3ERKS_RK10QByteArray(arg0: *mut c_void, arg1: *mut c_void) -> *mut c_void;
} // <= ext block end
...
impl<'a> /*trait*/ QUuid_new for (&'a QString) {
  fn new(self) -> QUuid {
    ...
    let qthis: u64 = unsafe {C_ZN5QUuidC2ERK7QString(arg0)};
...
impl<'a> /*trait*/ QUuid_toRfc4122<QByteArray> for () {
  fn toRfc4122(self , rsthis: & QUuid) -> QByteArray {
    ...
    let mut ret = unsafe {C_ZNK5QUuid9toRfc4122Ev(rsthis.qclsinst)};
...
impl<'a> /*trait*/ QUuid_toString<QString> for () {
  fn toString(self , rsthis: & QUuid) -> QString {
    ...
    let mut ret = unsafe {C_ZNK5QUuid8toStringEv(rsthis.qclsinst)};
...
impl<'a> /*trait*/ QUuid_createUuidV5_s<QUuid> for (&'a QUuid, &'a QString) {
  fn createUuidV5_s(self ) -> QUuid {
    ...
    let mut ret = unsafe {C_ZN5QUuid12createUuidV5ERKS_RK7QString(arg0, arg1)};
...
impl<'a> /*trait*/ QUuid_createUuid_s<QUuid> for () {
  fn createUuid_s(self ) -> QUuid {
    ...
    let mut ret = unsafe {C_ZN5QUuid10createUuidEv()};
    let mut ret1 = QUuid::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_new for (u32, u16, u16, u8, u8, u8, u8, u8, u8, u8, u8) {
  fn new(self) -> QUuid {
    ...
    let qthis: u64 = unsafe {C_ZN5QUuidC2Ejtthhhhhhhh(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)};
    let rsthis = QUuid{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_new for (&'a QByteArray) {
  fn new(self) -> QUuid {
    ...
    let qthis_ph: u64 = unsafe{calloc(1, ctysz as usize)} as u64;
    let arg0 = self.qclsinst  as *mut c_void;
    let qthis: u64 = unsafe {C_ZN5QUuidC2ERK10QByteArray(arg0)};
    let rsthis = QUuid{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_createUuidV3_s<QUuid> for (&'a QUuid, &'a QString) {
  fn createUuidV3_s(self ) -> QUuid {
    ...
    let arg0 = self.0.qclsinst  as *mut c_void;
    let arg1 = self.1.qclsinst  as *mut c_void;
    let mut ret = unsafe {C_ZN5QUuid12createUuidV3ERKS_RK7QString(arg0, arg1)};
    let mut ret1 = QUuid::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_new for () {
  fn new(self) -> QUuid {
    ...
    let ctysz: c_int = unsafe{QUuid_Class_Size()};
    let qthis_ph: u64 = unsafe{calloc(1, ctysz as usize)} as u64;
    let qthis: u64 = unsafe {C_ZN5QUuidC2Ev()};
    let rsthis = QUuid{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_toByteArray<QByteArray> for () {
  fn toByteArray(self , rsthis: & QUuid) -> QByteArray {
    ...
    let mut ret = unsafe {C_ZNK5QUuid11toByteArrayEv(rsthis.qclsinst)};
    let mut ret1 = QByteArray::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_new for (&'a  String) {
  fn new(self) -> QUuid {
    ...
    let qthis: u64 = unsafe {C_ZN5QUuidC2EPKc(arg0)};
    let rsthis = QUuid{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_createUuidV5_s<QUuid> for (&'a QUuid, &'a QByteArray) {
  fn createUuidV5_s(self ) -> QUuid {
    ...
    let arg0 = self.0.qclsinst  as *mut c_void;
    let arg1 = self.1.qclsinst  as *mut c_void;
    let mut ret = unsafe {C_ZN5QUuid12createUuidV5ERKS_RK10QByteArray(arg0, arg1)};
    let mut ret1 = QUuid::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_fromRfc4122_s<QUuid> for (&'a QByteArray) {
  fn fromRfc4122_s(self ) -> QUuid {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
    let mut ret = unsafe {C_ZN5QUuid11fromRfc4122ERK10QByteArray(arg0)};
    let mut ret1 = QUuid::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QUuid_createUuidV3_s<QUuid> for (&'a QUuid, &'a QByteArray) {
  fn createUuidV3_s(self ) -> QUuid {
    ...
    let arg0 = self.0.qclsinst  as *mut c_void;
    let arg1 = self.1.qclsinst  as *mut c_void;
    let mut ret = unsafe {C_ZN5QUuid12createUuidV3ERKS_RK10QByteArray(arg0, arg1)};
    let mut ret1 = QUuid::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
