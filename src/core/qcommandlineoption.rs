...
extern {
  ...
  fn _ZN18QCommandLineOptionC2ERKS_(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  ...
  fn _ZN18QCommandLineOptionC2ERK7QStringS2_S2_S2_(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: *mut c_void, arg2: *mut c_void, arg3: *mut c_void);
  ...
  fn _ZN18QCommandLineOptionC2ERK11QStringListRK7QStringS5_S5_(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: *mut c_void, arg2: *mut c_void, arg3: *mut c_void);
  // proto:  void QCommandLineOption::swap(QCommandLineOption & other);
  fn _ZN18QCommandLineOption4swapERS_(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  ...
  fn _ZN18QCommandLineOptionD2Ev(qthis: u64 /* *mut c_void*/);
  // proto:  void QCommandLineOption::QCommandLineOption(const QStringList & names);
  fn _ZN18QCommandLineOptionC2ERK11QStringList(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  ...
  fn _ZN18QCommandLineOptionC2ERK7QString(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
...
impl<'a> /*trait*/ QCommandLineOption_new for (&'a QCommandLineOption) {
  fn new(self) -> QCommandLineOption {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
    unsafe {_ZN18QCommandLineOptionC2ERKS_(qthis_ph, arg0)};
...
impl<'a> /*trait*/ QCommandLineOption_new for (&'a QString, &'a QString, &'a QString, &'a QString) {
  fn new(self) -> QCommandLineOption {
    ...
    unsafe {_ZN18QCommandLineOptionC2ERK7QStringS2_S2_S2_(qthis_ph, arg0, arg1, arg2, arg3)};
    let qthis: u64 = qthis_ph;
    let rsthis = QCommandLineOption{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
...
impl<'a> /*trait*/ QCommandLineOption_new for (&'a QStringList, &'a QString, &'a QString, &'a QString) {
  fn new(self) -> QCommandLineOption {
    ...
    let arg2 = self.2.qclsinst  as *mut c_void;
    let arg3 = self.3.qclsinst  as *mut c_void;
    unsafe {_ZN18QCommandLineOptionC2ERK11QStringListRK7QStringS5_S5_(qthis_ph, arg0, arg1, arg2, arg3)};
    let qthis: u64 = qthis_ph;
    let rsthis = QCommandLineOption{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
...
impl<'a> /*trait*/ QCommandLineOption_free<()> for () {
  fn free(self , rsthis: & QCommandLineOption) -> () {
    ...
    // unsafe{_ZN18QCommandLineOptionD2Ev()};
     unsafe {_ZN18QCommandLineOptionD2Ev(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QCommandLineOption_new for (&'a QStringList) {
  fn new(self) -> QCommandLineOption {
    ...
    let qthis_ph: u64 = unsafe{calloc(1, ctysz as usize)} as u64;
    let arg0 = self.qclsinst  as *mut c_void;
    unsafe {_ZN18QCommandLineOptionC2ERK11QStringList(qthis_ph, arg0)};
    let qthis: u64 = qthis_ph;
    let rsthis = QCommandLineOption{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
...
impl<'a> /*trait*/ QCommandLineOption_new for (&'a QString) {
  fn new(self) -> QCommandLineOption {
    ...
    let qthis_ph: u64 = unsafe{calloc(1, ctysz as usize)} as u64;
    let arg0 = self.qclsinst  as *mut c_void;
    unsafe {_ZN18QCommandLineOptionC2ERK7QString(qthis_ph, arg0)};
    let qthis: u64 = qthis_ph;
    let rsthis = QCommandLineOption{qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
