...
pub trait QFutureInterfaceBase_progressMinimum<RetType> {
  fn progressMinimum(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  int QFutureInterfaceBase::progressMinimum();
impl<'a> /*trait*/ QFutureInterfaceBase_progressMinimum<i32> for () {
  fn progressMinimum(self , rsthis: &mut QFutureInterfaceBase) -> i32 {
  ...
  // proto:  bool QFutureInterfaceBase::isStarted();
impl /*struct*/ QFutureInterfaceBase {
  pub fn isStarted<RetType, T: QFutureInterfaceBase_isStarted<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isStarted<RetType> {
  fn isStarted(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isStarted();
impl<'a> /*trait*/ QFutureInterfaceBase_isStarted<i8> for () {
  fn isStarted(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  QMutex * QFutureInterfaceBase::mutex();
impl /*struct*/ QFutureInterfaceBase {
  pub fn mutex<RetType, T: QFutureInterfaceBase_mutex<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_mutex<RetType> {
  fn mutex(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  QMutex * QFutureInterfaceBase::mutex();
impl<'a> /*trait*/ QFutureInterfaceBase_mutex<QMutex> for () {
  fn mutex(self , rsthis: &mut QFutureInterfaceBase) -> QMutex {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::isResultReadyAt(int index);
impl /*struct*/ QFutureInterfaceBase {
  pub fn isResultReadyAt<RetType, T: QFutureInterfaceBase_isResultReadyAt<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isResultReadyAt<RetType> {
  fn isResultReadyAt(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isResultReadyAt(int index);
impl<'a> /*trait*/ QFutureInterfaceBase_isResultReadyAt<i8> for (i32) {
  fn isResultReadyAt(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setPaused(bool paused);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setPaused<RetType, T: QFutureInterfaceBase_setPaused<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setPaused<RetType> {
  fn setPaused(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setPaused(bool paused);
impl<'a> /*trait*/ QFutureInterfaceBase_setPaused<()> for (i8) {
  fn setPaused(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  int QFutureInterfaceBase::expectedResultCount();
impl /*struct*/ QFutureInterfaceBase {
  pub fn expectedResultCount<RetType, T: QFutureInterfaceBase_expectedResultCount<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_expectedResultCount<RetType> {
  fn expectedResultCount(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  int QFutureInterfaceBase::expectedResultCount();
impl<'a> /*trait*/ QFutureInterfaceBase_expectedResultCount<i32> for () {
  fn expectedResultCount(self , rsthis: &mut QFutureInterfaceBase) -> i32 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::waitForFinished();
impl /*struct*/ QFutureInterfaceBase {
  pub fn waitForFinished<RetType, T: QFutureInterfaceBase_waitForFinished<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_waitForFinished<RetType> {
  fn waitForFinished(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::waitForFinished();
impl<'a> /*trait*/ QFutureInterfaceBase_waitForFinished<()> for () {
  fn waitForFinished(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::isRunning();
impl /*struct*/ QFutureInterfaceBase {
  pub fn isRunning<RetType, T: QFutureInterfaceBase_isRunning<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isRunning<RetType> {
  fn isRunning(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isRunning();
impl<'a> /*trait*/ QFutureInterfaceBase_isRunning<i8> for () {
  fn isRunning(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::~QFutureInterfaceBase();
impl /*struct*/ QFutureInterfaceBase {
  pub fn FreeQFutureInterfaceBase<RetType, T: QFutureInterfaceBase_FreeQFutureInterfaceBase<RetType>>(&mut self,  overload_args: T) -> RetType {
    return overload_args.FreeQFutureInterfaceBase(self);
    // return 1;
  }
}

pub trait QFutureInterfaceBase_FreeQFutureInterfaceBase<RetType> {
  fn FreeQFutureInterfaceBase(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::~QFutureInterfaceBase();
impl<'a> /*trait*/ QFutureInterfaceBase_FreeQFutureInterfaceBase<()> for () {
  fn FreeQFutureInterfaceBase(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::cancel();
impl /*struct*/ QFutureInterfaceBase {
  pub fn cancel<RetType, T: QFutureInterfaceBase_cancel<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_cancel<RetType> {
  fn cancel(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::cancel();
impl<'a> /*trait*/ QFutureInterfaceBase_cancel<()> for () {
  fn cancel(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::reportStarted();
impl /*struct*/ QFutureInterfaceBase {
  pub fn reportStarted<RetType, T: QFutureInterfaceBase_reportStarted<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_reportStarted<RetType> {
  fn reportStarted(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::reportStarted();
impl<'a> /*trait*/ QFutureInterfaceBase_reportStarted<()> for () {
  fn reportStarted(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setRunnable(QRunnable * runnable);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setRunnable<RetType, T: QFutureInterfaceBase_setRunnable<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setRunnable<RetType> {
  fn setRunnable(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setRunnable(QRunnable * runnable);
impl<'a> /*trait*/ QFutureInterfaceBase_setRunnable<()> for (QRunnable) {
  fn setRunnable(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::isCanceled();
impl /*struct*/ QFutureInterfaceBase {
  pub fn isCanceled<RetType, T: QFutureInterfaceBase_isCanceled<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isCanceled<RetType> {
  fn isCanceled(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isCanceled();
impl<'a> /*trait*/ QFutureInterfaceBase_isCanceled<i8> for () {
  fn isCanceled(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  QString QFutureInterfaceBase::progressText();
impl /*struct*/ QFutureInterfaceBase {
  pub fn progressText<RetType, T: QFutureInterfaceBase_progressText<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_progressText<RetType> {
  fn progressText(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  QString QFutureInterfaceBase::progressText();
impl<'a> /*trait*/ QFutureInterfaceBase_progressText<QString> for () {
  fn progressText(self , rsthis: &mut QFutureInterfaceBase) -> QString {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::isProgressUpdateNeeded();
impl /*struct*/ QFutureInterfaceBase {
  pub fn isProgressUpdateNeeded<RetType, T: QFutureInterfaceBase_isProgressUpdateNeeded<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isProgressUpdateNeeded<RetType> {
  fn isProgressUpdateNeeded(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isProgressUpdateNeeded();
impl<'a> /*trait*/ QFutureInterfaceBase_isProgressUpdateNeeded<i8> for () {
  fn isProgressUpdateNeeded(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setExpectedResultCount(int resultCount);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setExpectedResultCount<RetType, T: QFutureInterfaceBase_setExpectedResultCount<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setExpectedResultCount<RetType> {
  fn setExpectedResultCount(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setExpectedResultCount(int resultCount);
impl<'a> /*trait*/ QFutureInterfaceBase_setExpectedResultCount<()> for (i32) {
  fn setExpectedResultCount(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::reportResultsReady(int beginIndex, int endIndex);
impl /*struct*/ QFutureInterfaceBase {
  pub fn reportResultsReady<RetType, T: QFutureInterfaceBase_reportResultsReady<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_reportResultsReady<RetType> {
  fn reportResultsReady(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::reportResultsReady(int beginIndex, int endIndex);
impl<'a> /*trait*/ QFutureInterfaceBase_reportResultsReady<()> for (i32, i32) {
  fn reportResultsReady(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::reportCanceled();
impl /*struct*/ QFutureInterfaceBase {
  pub fn reportCanceled<RetType, T: QFutureInterfaceBase_reportCanceled<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_reportCanceled<RetType> {
  fn reportCanceled(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::reportCanceled();
impl<'a> /*trait*/ QFutureInterfaceBase_reportCanceled<()> for () {
  fn reportCanceled(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  int QFutureInterfaceBase::resultCount();
impl /*struct*/ QFutureInterfaceBase {
  pub fn resultCount<RetType, T: QFutureInterfaceBase_resultCount<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_resultCount<RetType> {
  fn resultCount(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  int QFutureInterfaceBase::resultCount();
impl<'a> /*trait*/ QFutureInterfaceBase_resultCount<i32> for () {
  fn resultCount(self , rsthis: &mut QFutureInterfaceBase) -> i32 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::QFutureInterfaceBase(const QFutureInterfaceBase & other);
impl /*struct*/ QFutureInterfaceBase {
  pub fn NewQFutureInterfaceBase<T: QFutureInterfaceBase_NewQFutureInterfaceBase>(value: T) -> QFutureInterfaceBase {
    let rsthis = value.NewQFutureInterfaceBase();
    return rsthis;
    // return 1;
  }
}

pub trait QFutureInterfaceBase_NewQFutureInterfaceBase {
  fn NewQFutureInterfaceBase(self) -> QFutureInterfaceBase;
}

  // proto:  void QFutureInterfaceBase::QFutureInterfaceBase(const QFutureInterfaceBase & other);
impl<'a> /*trait*/ QFutureInterfaceBase_NewQFutureInterfaceBase for (QFutureInterfaceBase) {
  fn NewQFutureInterfaceBase(self) -> QFutureInterfaceBase {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  int QFutureInterfaceBase::progressValue();
impl /*struct*/ QFutureInterfaceBase {
  pub fn progressValue<RetType, T: QFutureInterfaceBase_progressValue<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_progressValue<RetType> {
  fn progressValue(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  int QFutureInterfaceBase::progressValue();
impl<'a> /*trait*/ QFutureInterfaceBase_progressValue<i32> for () {
  fn progressValue(self , rsthis: &mut QFutureInterfaceBase) -> i32 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::isThrottled();
impl /*struct*/ QFutureInterfaceBase {
  pub fn isThrottled<RetType, T: QFutureInterfaceBase_isThrottled<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isThrottled<RetType> {
  fn isThrottled(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isThrottled();
impl<'a> /*trait*/ QFutureInterfaceBase_isThrottled<i8> for () {
  fn isThrottled(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setProgressRange(int minimum, int maximum);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setProgressRange<RetType, T: QFutureInterfaceBase_setProgressRange<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setProgressRange<RetType> {
  fn setProgressRange(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setProgressRange(int minimum, int maximum);
impl<'a> /*trait*/ QFutureInterfaceBase_setProgressRange<()> for (i32, i32) {
  fn setProgressRange(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setThrottled(bool enable);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setThrottled<RetType, T: QFutureInterfaceBase_setThrottled<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setThrottled<RetType> {
  fn setThrottled(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setThrottled(bool enable);
impl<'a> /*trait*/ QFutureInterfaceBase_setThrottled<()> for (i8) {
  fn setThrottled(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setProgressValueAndText(int progressValue, const QString & progressText);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setProgressValueAndText<RetType, T: QFutureInterfaceBase_setProgressValueAndText<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setProgressValueAndText<RetType> {
  fn setProgressValueAndText(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setProgressValueAndText(int progressValue, const QString & progressText);
impl<'a> /*trait*/ QFutureInterfaceBase_setProgressValueAndText<()> for (i32, QString) {
  fn setProgressValueAndText(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::togglePaused();
impl /*struct*/ QFutureInterfaceBase {
  pub fn togglePaused<RetType, T: QFutureInterfaceBase_togglePaused<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_togglePaused<RetType> {
  fn togglePaused(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::togglePaused();
impl<'a> /*trait*/ QFutureInterfaceBase_togglePaused<()> for () {
  fn togglePaused(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::waitForResult(int resultIndex);
impl /*struct*/ QFutureInterfaceBase {
  pub fn waitForResult<RetType, T: QFutureInterfaceBase_waitForResult<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_waitForResult<RetType> {
  fn waitForResult(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::waitForResult(int resultIndex);
impl<'a> /*trait*/ QFutureInterfaceBase_waitForResult<()> for (i32) {
  fn waitForResult(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::isPaused();
impl /*struct*/ QFutureInterfaceBase {
  pub fn isPaused<RetType, T: QFutureInterfaceBase_isPaused<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isPaused<RetType> {
  fn isPaused(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isPaused();
impl<'a> /*trait*/ QFutureInterfaceBase_isPaused<i8> for () {
  fn isPaused(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::waitForNextResult();
impl /*struct*/ QFutureInterfaceBase {
  pub fn waitForNextResult<RetType, T: QFutureInterfaceBase_waitForNextResult<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_waitForNextResult<RetType> {
  fn waitForNextResult(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::waitForNextResult();
impl<'a> /*trait*/ QFutureInterfaceBase_waitForNextResult<i8> for () {
  fn waitForNextResult(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::reportFinished();
impl /*struct*/ QFutureInterfaceBase {
  pub fn reportFinished<RetType, T: QFutureInterfaceBase_reportFinished<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_reportFinished<RetType> {
  fn reportFinished(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::reportFinished();
impl<'a> /*trait*/ QFutureInterfaceBase_reportFinished<()> for () {
  fn reportFinished(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setFilterMode(bool enable);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setFilterMode<RetType, T: QFutureInterfaceBase_setFilterMode<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setFilterMode<RetType> {
  fn setFilterMode(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setFilterMode(bool enable);
impl<'a> /*trait*/ QFutureInterfaceBase_setFilterMode<()> for (i8) {
  fn setFilterMode(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  int QFutureInterfaceBase::progressMaximum();
impl /*struct*/ QFutureInterfaceBase {
  pub fn progressMaximum<RetType, T: QFutureInterfaceBase_progressMaximum<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_progressMaximum<RetType> {
  fn progressMaximum(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  int QFutureInterfaceBase::progressMaximum();
impl<'a> /*trait*/ QFutureInterfaceBase_progressMaximum<i32> for () {
  fn progressMaximum(self , rsthis: &mut QFutureInterfaceBase) -> i32 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setThreadPool(QThreadPool * pool);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setThreadPool<RetType, T: QFutureInterfaceBase_setThreadPool<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setThreadPool<RetType> {
  fn setThreadPool(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setThreadPool(QThreadPool * pool);
impl<'a> /*trait*/ QFutureInterfaceBase_setThreadPool<()> for (QThreadPool) {
  fn setThreadPool(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::waitForResume();
impl /*struct*/ QFutureInterfaceBase {
  pub fn waitForResume<RetType, T: QFutureInterfaceBase_waitForResume<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_waitForResume<RetType> {
  fn waitForResume(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::waitForResume();
impl<'a> /*trait*/ QFutureInterfaceBase_waitForResume<()> for () {
  fn waitForResume(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QFutureInterfaceBase::setProgressValue(int progressValue);
impl /*struct*/ QFutureInterfaceBase {
  pub fn setProgressValue<RetType, T: QFutureInterfaceBase_setProgressValue<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_setProgressValue<RetType> {
  fn setProgressValue(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  void QFutureInterfaceBase::setProgressValue(int progressValue);
impl<'a> /*trait*/ QFutureInterfaceBase_setProgressValue<()> for (i32) {
  fn setProgressValue(self , rsthis: &mut QFutureInterfaceBase) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QFutureInterfaceBase::isFinished();
impl /*struct*/ QFutureInterfaceBase {
  pub fn isFinished<RetType, T: QFutureInterfaceBase_isFinished<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QFutureInterfaceBase_isFinished<RetType> {
  fn isFinished(self , rsthis: &mut QFutureInterfaceBase) -> RetType;
}

  // proto:  bool QFutureInterfaceBase::isFinished();
impl<'a> /*trait*/ QFutureInterfaceBase_isFinished<i8> for () {
  fn isFinished(self , rsthis: &mut QFutureInterfaceBase) -> i8 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
