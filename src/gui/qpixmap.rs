...
use super::qimagereader::*; // 773
// use super::qplatformpixmap::*; // 775
...
extern {
  ...
  fn C_ZNK7QPixmap4saveERK7QStringPKci(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: *mut c_char, arg2: c_int) -> c_char;
  // proto:  void QPixmap::swap(QPixmap & other);
  fn C_ZN7QPixmap4swapERS_(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  bool QPixmap::isQBitmap();
  fn C_ZNK7QPixmap9isQBitmapEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  qreal QPixmap::devicePixelRatio();
  fn C_ZNK7QPixmap16devicePixelRatioEv(qthis: u64 /* *mut c_void*/) -> c_double;
  // proto:  void QPixmap::QPixmap(const QSize & );
  fn C_ZN7QPixmapC2ERK5QSize(arg0: *mut c_void) -> u64;
  // proto:  void QPixmap::fill(const QPaintDevice * device, int xofs, int yofs);
  fn C_ZN7QPixmap4fillEPK12QPaintDeviceii(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: c_int, arg2: c_int);
  // proto:  void QPixmap::fill(const QColor & fillColor);
  fn C_ZN7QPixmap4fillERK6QColor(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  int QPixmap::devType();
  fn C_ZNK7QPixmap7devTypeEv(qthis: u64 /* *mut c_void*/) -> c_int;
  // proto:  void QPixmap::scroll(int dx, int dy, int x, int y, int width, int height, QRegion * exposed);
  fn C_ZN7QPixmap6scrollEiiiiiiP7QRegion(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int, arg2: c_int, arg3: c_int, arg4: c_int, arg5: c_int, arg6: *mut c_void);
  // proto:  QPixmap QPixmap::copy(const QRect & rect);
  fn C_ZNK7QPixmap4copyERK5QRect(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  // proto: static QTransform QPixmap::trueMatrix(const QTransform & m, int w, int h);
  fn C_ZN7QPixmap10trueMatrixERK10QTransformii(arg0: *mut c_void, arg1: c_int, arg2: c_int) -> *mut c_void;
  // proto:  void QPixmap::QPixmap(int w, int h);
  fn C_ZN7QPixmapC2Eii(arg0: c_int, arg1: c_int) -> u64;
  // proto: static QPixmap QPixmap::grabWindow(WId , int x, int y, int w, int h);
  fn C_ZN7QPixmap10grabWindowEiiiii(arg0: c_int, arg1: c_int, arg2: c_int, arg3: c_int, arg4: c_int) -> *mut c_void;
  // proto:  void QPixmap::fill(const QPaintDevice * device, const QPoint & ofs);
  fn C_ZN7QPixmap4fillEPK12QPaintDeviceRK6QPoint(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: *mut c_void);
  // proto:  bool QPixmap::isDetached();
  fn C_ZNK7QPixmap10isDetachedEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  bool QPixmap::isNull();
  fn C_ZNK7QPixmap6isNullEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  QPixmap QPixmap::copy(int x, int y, int width, int height);
  fn C_ZNK7QPixmap4copyEiiii(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int, arg2: c_int, arg3: c_int) -> *mut c_void;
  // proto: static int QPixmap::defaultDepth();
  fn C_ZN7QPixmap12defaultDepthEv() -> c_int;
  // proto:  void QPixmap::detach();
  fn C_ZN7QPixmap6detachEv(qthis: u64 /* *mut c_void*/);
  // proto:  void QPixmap::scroll(int dx, int dy, const QRect & rect, QRegion * exposed);
  fn C_ZN7QPixmap6scrollEiiRK5QRectP7QRegion(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int, arg2: *mut c_void, arg3: *mut c_void);
  // proto:  void QPixmap::setMask(const QBitmap & );
  fn C_ZN7QPixmap7setMaskERK7QBitmap(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  void QPixmap::QPixmap();
  fn C_ZN7QPixmapC2Ev() -> u64;
  // proto: static QPixmap QPixmap::grabWidget(QObject * widget, const QRect & rect);
  fn C_ZN7QPixmap10grabWidgetEP7QObjectRK5QRect(arg0: *mut c_void, arg1: *mut c_void) -> *mut c_void;
  // proto:  void QPixmap::QPixmap(const QPixmap & );
  fn C_ZN7QPixmapC2ERKS_(arg0: *mut c_void) -> u64;
  // proto:  void QPixmap::setDevicePixelRatio(qreal scaleFactor);
  fn C_ZN7QPixmap19setDevicePixelRatioEd(qthis: u64 /* *mut c_void*/, arg0: c_double);
  // proto:  void QPixmap::QPixmap(const char *const [] xpm);
  fn C_ZN7QPixmapC2EPKPKc(arg0: *mut *mut c_char) -> u64;
  // proto:  qint64 QPixmap::cacheKey();
  fn C_ZNK7QPixmap8cacheKeyEv(qthis: u64 /* *mut c_void*/) -> c_longlong;
  // proto:  QBitmap QPixmap::createHeuristicMask(bool clipTight);
  fn C_ZNK7QPixmap19createHeuristicMaskEb(qthis: u64 /* *mut c_void*/, arg0: c_char) -> *mut c_void;
  // proto:  int QPixmap::depth();
  fn C_ZNK7QPixmap5depthEv(qthis: u64 /* *mut c_void*/) -> c_int;
  // proto:  QImage QPixmap::toImage();
  fn C_ZNK7QPixmap7toImageEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto: static QPixmap QPixmap::grabWidget(QObject * widget, int x, int y, int w, int h);
  fn C_ZN7QPixmap10grabWidgetEP7QObjectiiii(arg0: *mut c_void, arg1: c_int, arg2: c_int, arg3: c_int, arg4: c_int) -> *mut c_void;
  // proto:  QPlatformPixmap * QPixmap::handle();
  fn C_ZNK7QPixmap6handleEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  bool QPixmap::hasAlphaChannel();
  fn C_ZNK7QPixmap15hasAlphaChannelEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  QRect QPixmap::rect();
  fn C_ZNK7QPixmap4rectEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto: static QMatrix QPixmap::trueMatrix(const QMatrix & m, int w, int h);
  fn C_ZN7QPixmap10trueMatrixERK7QMatrixii(arg0: *mut c_void, arg1: c_int, arg2: c_int) -> *mut c_void;
  // proto:  QBitmap QPixmap::mask();
  fn C_ZNK7QPixmap4maskEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  int QPixmap::width();
  fn C_ZNK7QPixmap5widthEv(qthis: u64 /* *mut c_void*/) -> c_int;
  // proto:  QPaintEngine * QPixmap::paintEngine();
  fn C_ZNK7QPixmap11paintEngineEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  void QPixmap::~QPixmap();
  fn C_ZN7QPixmapD2Ev(qthis: u64 /* *mut c_void*/);
  // proto:  int QPixmap::height();
  fn C_ZNK7QPixmap6heightEv(qthis: u64 /* *mut c_void*/) -> c_int;
  // proto:  bool QPixmap::save(QIODevice * device, const char * format, int quality);
  fn C_ZNK7QPixmap4saveEP9QIODevicePKci(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: *mut c_char, arg2: c_int) -> c_char;
  // proto:  QSize QPixmap::size();
  fn C_ZNK7QPixmap4sizeEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  bool QPixmap::hasAlpha();
  fn C_ZNK7QPixmap8hasAlphaEv(qthis: u64 /* *mut c_void*/) -> c_char;
} // <= ext block end
...
impl<'a> /*trait*/ QPixmap_swap<()> for (&'a QPixmap) {
  fn swap(self , rsthis: & QPixmap) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {C_ZN7QPixmap4swapERS_(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_isQBitmap<i8> for () {
  fn isQBitmap(self , rsthis: & QPixmap) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap9isQBitmapEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_devicePixelRatio<f64> for () {
  fn devicePixelRatio(self , rsthis: & QPixmap) -> f64 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap16devicePixelRatioEv(rsthis.qclsinst)};
    return ret as f64; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_new for (&'a QSize) {
  fn new(self) -> QPixmap {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
    let qthis: u64 = unsafe {C_ZN7QPixmapC2ERK5QSize(arg0)};
...
impl<'a> /*trait*/ QPixmap_fill<()> for (&'a QPaintDevice, i32, i32) {
  fn fill(self , rsthis: & QPixmap) -> () {
    ...
    let arg2 = self.2  as c_int;
     unsafe {C_ZN7QPixmap4fillEPK12QPaintDeviceii(rsthis.qclsinst, arg0, arg1, arg2)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_devType<i32> for () {
  fn devType(self , rsthis: & QPixmap) -> i32 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap7devTypeEv(rsthis.qclsinst)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_trueMatrix_s<QTransform> for (&'a QTransform, i32, i32) {
  fn trueMatrix_s(self ) -> QTransform {
    ...
    let arg1 = self.1  as c_int;
    let arg2 = self.2  as c_int;
    let mut ret = unsafe {C_ZN7QPixmap10trueMatrixERK10QTransformii(arg0, arg1, arg2)};
...
impl<'a> /*trait*/ QPixmap_new for (i32, i32) {
  fn new(self) -> QPixmap {
    ...
    let arg0 = self.0  as c_int;
    let arg1 = self.1  as c_int;
    let qthis: u64 = unsafe {C_ZN7QPixmapC2Eii(arg0, arg1)};
    let rsthis = QPixmap{qbase: QPaintDevice::inheritFrom(qthis), qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QPixmap_fill<()> for (&'a QPaintDevice, &'a QPoint) {
  fn fill(self , rsthis: & QPixmap) -> () {
    ...
    let arg1 = self.1.qclsinst  as *mut c_void;
     unsafe {C_ZN7QPixmap4fillEPK12QPaintDeviceRK6QPoint(rsthis.qclsinst, arg0, arg1)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_isDetached<i8> for () {
  fn isDetached(self , rsthis: & QPixmap) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap10isDetachedEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_isNull<i8> for () {
  fn isNull(self , rsthis: & QPixmap) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap6isNullEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_copy<QPixmap> for (i32, i32, i32, i32) {
  fn copy(self , rsthis: & QPixmap) -> QPixmap {
    ...
    let arg2 = self.2  as c_int;
    let arg3 = self.3  as c_int;
    let mut ret = unsafe {C_ZNK7QPixmap4copyEiiii(rsthis.qclsinst, arg0, arg1, arg2, arg3)};
    let mut ret1 = QPixmap::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QPixmap_defaultDepth_s<i32> for () {
  fn defaultDepth_s(self ) -> i32 {
    ...
    let mut ret = unsafe {C_ZN7QPixmap12defaultDepthEv()};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_detach<()> for () {
  fn detach(self , rsthis: & QPixmap) -> () {
    ...
    // unsafe{_ZN7QPixmap6detachEv()};
     unsafe {C_ZN7QPixmap6detachEv(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_setMask<()> for (&'a QBitmap) {
  fn setMask(self , rsthis: & QPixmap) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {C_ZN7QPixmap7setMaskERK7QBitmap(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_new for () {
  fn new(self) -> QPixmap {
    ...
    let ctysz: c_int = unsafe{QPixmap_Class_Size()};
    let qthis_ph: u64 = unsafe{calloc(1, ctysz as usize)} as u64;
    let qthis: u64 = unsafe {C_ZN7QPixmapC2Ev()};
    let rsthis = QPixmap{qbase: QPaintDevice::inheritFrom(qthis), qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QPixmap_grabWidget_s<QPixmap> for (&'a QObject, &'a QRect) {
  fn grabWidget_s(self ) -> QPixmap {
    ...
    let arg0 = self.0.qclsinst  as *mut c_void;
    let arg1 = self.1.qclsinst  as *mut c_void;
    let mut ret = unsafe {C_ZN7QPixmap10grabWidgetEP7QObjectRK5QRect(arg0, arg1)};
    let mut ret1 = QPixmap::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QPixmap_new for (&'a QPixmap) {
  fn new(self) -> QPixmap {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
    // unsafe{_ZN7QPixmapC2ERKS_()};
    let ctysz: c_int = unsafe{QPixmap_Class_Size()};
    let qthis_ph: u64 = unsafe{calloc(1, ctysz as usize)} as u64;
    let arg0 = self.qclsinst  as *mut c_void;
    let qthis: u64 = unsafe {C_ZN7QPixmapC2ERKS_(arg0)};
    let rsthis = QPixmap{qbase: QPaintDevice::inheritFrom(qthis), qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QPixmap_setDevicePixelRatio<()> for (f64) {
  fn setDevicePixelRatio(self , rsthis: & QPixmap) -> () {
    ...
    let arg0 = self  as c_double;
     unsafe {C_ZN7QPixmap19setDevicePixelRatioEd(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_new for (&'a  Vec<&'a  i8>) {
  fn new(self) -> QPixmap {
    ...
    let qthis: u64 = unsafe {C_ZN7QPixmapC2EPKPKc(arg0)};
    let rsthis = QPixmap{qbase: QPaintDevice::inheritFrom(qthis), qclsinst: qthis, ..Default::default()};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QPixmap_cacheKey<i64> for () {
  fn cacheKey(self , rsthis: & QPixmap) -> i64 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap8cacheKeyEv(rsthis.qclsinst)};
    return ret as i64; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_depth<i32> for () {
  fn depth(self , rsthis: & QPixmap) -> i32 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap5depthEv(rsthis.qclsinst)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_toImage<QImage> for () {
  fn toImage(self , rsthis: & QPixmap) -> QImage {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap7toImageEv(rsthis.qclsinst)};
...
pub trait QPixmap_handle<RetType> {
  ...
  // proto:  QPlatformPixmap * QPixmap::handle();
impl<'a> /*trait*/ QPixmap_handle<u64> for () {
  fn handle(self , rsthis: & QPixmap) -> u64 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
    // unsafe{_ZNK7QPixmap6handleEv()};
    let mut ret = unsafe {C_ZNK7QPixmap6handleEv(rsthis.qclsinst)};
    return ret as u64; // 4
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_hasAlphaChannel<i8> for () {
  fn hasAlphaChannel(self , rsthis: & QPixmap) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap15hasAlphaChannelEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_rect<QRect> for () {
  fn rect(self , rsthis: & QPixmap) -> QRect {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap4rectEv(rsthis.qclsinst)};
...
impl<'a> /*trait*/ QPixmap_trueMatrix_s<QMatrix> for (&'a QMatrix, i32, i32) {
  fn trueMatrix_s(self ) -> QMatrix {
    ...
    let arg1 = self.1  as c_int;
    let arg2 = self.2  as c_int;
    let mut ret = unsafe {C_ZN7QPixmap10trueMatrixERK7QMatrixii(arg0, arg1, arg2)};
...
impl<'a> /*trait*/ QPixmap_mask<QBitmap> for () {
  fn mask(self , rsthis: & QPixmap) -> QBitmap {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap4maskEv(rsthis.qclsinst)};
    let mut ret1 = QBitmap::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QPixmap_width<i32> for () {
  fn width(self , rsthis: & QPixmap) -> i32 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap5widthEv(rsthis.qclsinst)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_paintEngine<QPaintEngine> for () {
  fn paintEngine(self , rsthis: & QPixmap) -> QPaintEngine {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap11paintEngineEv(rsthis.qclsinst)};
...
impl<'a> /*trait*/ QPixmap_free<()> for () {
  fn free(self , rsthis: & QPixmap) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
    // unsafe{_ZN7QPixmapD2Ev()};
     unsafe {C_ZN7QPixmapD2Ev(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_height<i32> for () {
  fn height(self , rsthis: & QPixmap) -> i32 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap6heightEv(rsthis.qclsinst)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QPixmap_size<QSize> for () {
  fn size(self , rsthis: & QPixmap) -> QSize {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap4sizeEv(rsthis.qclsinst)};
...
impl<'a> /*trait*/ QPixmap_hasAlpha<i8> for () {
  fn hasAlpha(self , rsthis: & QPixmap) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK7QPixmap8hasAlphaEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
