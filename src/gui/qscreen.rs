...
extern fn QScreen_primaryOrientationChanged_signal_connect_cb_box_0(rsfptr_raw:*mut Box<Fn(i32)>, arg0: c_int) {
  println!("{}:{}", file!(), line!());
...
extern fn QScreen_orientationChanged_signal_connect_cb_box_1(rsfptr_raw:*mut Box<Fn(i32)>, arg0: c_int) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = arg0 as i32;
  // rsfptr(rsarg0);
...
extern fn QScreen_logicalDotsPerInchChanged_signal_connect_cb_box_2(rsfptr_raw:*mut Box<Fn(f64)>, arg0: c_double) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = arg0 as f64;
  // rsfptr(rsarg0);
...
extern fn QScreen_availableGeometryChanged_signal_connect_cb_box_3(rsfptr_raw:*mut Box<Fn(QRect)>, arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QRect::inheritFrom(arg0 as u64);
  // rsfptr(rsarg0);
...
extern fn QScreen_geometryChanged_signal_connect_cb_box_4(rsfptr_raw:*mut Box<Fn(QRect)>, arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QRect::inheritFrom(arg0 as u64);
  // rsfptr(rsarg0);
...
extern fn QScreen_physicalDotsPerInchChanged_signal_connect_cb_box_5(rsfptr_raw:*mut Box<Fn(f64)>, arg0: c_double) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = arg0 as f64;
  // rsfptr(rsarg0);
...
extern fn QScreen_virtualGeometryChanged_signal_connect_cb_box_6(rsfptr_raw:*mut Box<Fn(QRect)>, arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QRect::inheritFrom(arg0 as u64);
  // rsfptr(rsarg0);
...
extern fn QScreen_refreshRateChanged_signal_connect_cb_box_7(rsfptr_raw:*mut Box<Fn(f64)>, arg0: c_double) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = arg0 as f64;
  // rsfptr(rsarg0);
...
extern fn QScreen_physicalSizeChanged_signal_connect_cb_box_8(rsfptr_raw:*mut Box<Fn(QSizeF)>, arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QSizeF::inheritFrom(arg0 as u64);
  // rsfptr(rsarg0);
