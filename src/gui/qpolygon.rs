...
impl<'a> /*trait*/ QPolygon_New for (&'a QPolygon) {
  fn New(self) -> QPolygon {
    ...
    let qthis: *mut c_void = unsafe {dector_ZN8QPolygonC1ERKS_(arg0)};
...
impl<'a> /*trait*/ QPolygon_New for () {
  fn New(self) -> QPolygon {
    ...
    let qthis: *mut c_void = unsafe {dector_ZN8QPolygonC1Ev()};
    let rsthis = QPolygon{qclsinst: qthis};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QPolygonF_New for () {
  fn New(self) -> QPolygonF {
    ...
    let qthis: *mut c_void = unsafe {dector_ZN9QPolygonFC1Ev()};
    let rsthis = QPolygonF{qclsinst: qthis};
    return rsthis;
    // return 1;
  }
...
impl<'a> /*trait*/ QPolygonF_New for (&'a QPolygonF) {
  fn New(self) -> QPolygonF {
    ...
    let qthis: *mut c_void = unsafe {dector_ZN9QPolygonFC1ERKS_(arg0)};
    let rsthis = QPolygonF{qclsinst: qthis};
    return rsthis;
    // return 1;
  }
