...
extern {
  ...
  fn demth_ZNK8QPalette6buttonEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::foreground();
  fn demth_ZNK8QPalette10foregroundEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::background();
  fn demth_ZNK8QPalette10backgroundEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  void QPalette::resolve(uint mask);
  fn demth_ZN8QPalette7resolveEj(qthis: *mut c_void, arg0: c_uint);
  // proto:  void QPalette::QPalette();
  ...
  fn demth_ZNK8QPalette7resolveEv(qthis: *mut c_void) -> c_uint;
  // proto:  const QBrush & QPalette::window();
  fn demth_ZNK8QPalette6windowEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::highlightedText();
  fn demth_ZNK8QPalette15highlightedTextEv(qthis: *mut c_void) -> *mut c_void;
  ...
  fn demth_ZNK8QPalette4textEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::light();
  fn demth_ZNK8QPalette5lightEv(qthis: *mut c_void) -> *mut c_void;
  ...
  fn demth_ZNK8QPalette4linkEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  qint64 QPalette::cacheKey();
  fn _ZNK8QPalette8cacheKeyEv(qthis: *mut c_void) -> c_longlong;
  // proto:  const QBrush & QPalette::base();
  fn demth_ZNK8QPalette4baseEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::dark();
  fn demth_ZNK8QPalette4darkEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::highlight();
  fn demth_ZNK8QPalette9highlightEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::mid();
  fn demth_ZNK8QPalette3midEv(qthis: *mut c_void) -> *mut c_void;
  ...
  fn demth_ZNK8QPalette6shadowEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::buttonText();
  fn demth_ZNK8QPalette10buttonTextEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::toolTipBase();
  fn demth_ZNK8QPalette11toolTipBaseEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::midlight();
  fn demth_ZNK8QPalette8midlightEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::brightText();
  fn demth_ZNK8QPalette10brightTextEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::linkVisited();
  fn demth_ZNK8QPalette11linkVisitedEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::alternateBase();
  fn demth_ZNK8QPalette13alternateBaseEv(qthis: *mut c_void) -> *mut c_void;
  ...
  fn demth_ZNK8QPalette10windowTextEv(qthis: *mut c_void) -> *mut c_void;
  // proto:  const QBrush & QPalette::toolTipText();
  fn demth_ZNK8QPalette11toolTipTextEv(qthis: *mut c_void) -> *mut c_void;
} // <= ext block end
