...
extern {
  ...
  fn _ZN13QGraphicsView5scaleEdd(qthis: u64 /* *mut c_void*/, arg0: c_double, arg1: c_double);
  // proto:  QPolygonF QGraphicsView::mapToScene(const QRect & rect);
  fn _ZNK13QGraphicsView10mapToSceneERK5QRect(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  // proto:  QPolygon QGraphicsView::mapFromScene(const QRectF & rect);
  fn _ZNK13QGraphicsView12mapFromSceneERK6QRectF(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  ...
  fn _ZN13QGraphicsView9setMatrixERK7QMatrixb(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: c_char);
  ...
  fn _ZN13QGraphicsView18setForegroundBrushERK6QBrush(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  void QGraphicsView::shear(qreal sh, qreal sv);
  fn _ZN13QGraphicsView5shearEdd(qthis: u64 /* *mut c_void*/, arg0: c_double, arg1: c_double);
  // proto:  QBrush QGraphicsView::foregroundBrush();
  fn _ZNK13QGraphicsView15foregroundBrushEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  QGraphicsItem * QGraphicsView::itemAt(const QPoint & pos);
  fn _ZNK13QGraphicsView6itemAtERK6QPoint(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  void QGraphicsView::updateSceneRect(const QRectF & rect);
  fn _ZN13QGraphicsView15updateSceneRectERK6QRectF(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  QPointF QGraphicsView::mapToScene(const QPoint & point);
  fn _ZNK13QGraphicsView10mapToSceneERK6QPoint(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  // proto:  void QGraphicsView::setInteractive(bool allowed);
  fn _ZN13QGraphicsView14setInteractiveEb(qthis: u64 /* *mut c_void*/, arg0: c_char);
  ...
  fn _ZNK13QGraphicsView17viewportTransformEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  void QGraphicsView::resetCachedContent();
  fn _ZN13QGraphicsView18resetCachedContentEv(qthis: u64 /* *mut c_void*/);
  // proto:  QPolygonF QGraphicsView::mapToScene(const QPolygon & polygon);
  fn _ZNK13QGraphicsView10mapToSceneERK8QPolygon(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  // proto:  void QGraphicsView::ensureVisible(const QGraphicsItem * item, int xmargin, int ymargin);
  fn _ZN13QGraphicsView13ensureVisibleEPK13QGraphicsItemii(qthis: u64 /* *mut c_void*/, arg0: *mut c_void, arg1: c_int, arg2: c_int);
  // proto:  QRectF QGraphicsView::sceneRect();
  fn _ZNK13QGraphicsView9sceneRectEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  QGraphicsScene * QGraphicsView::scene();
  fn _ZNK13QGraphicsView5sceneEv(qthis: u64 /* *mut c_void*/);
  // proto:  QSize QGraphicsView::sizeHint();
  fn _ZNK13QGraphicsView8sizeHintEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  ...
  fn _ZNK13QGraphicsView5itemsEv(qthis: u64 /* *mut c_void*/);
  ...
  fn _ZN13QGraphicsView12setSceneRectERK6QRectF(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  QPolygon QGraphicsView::mapFromScene(const QPolygonF & polygon);
  fn _ZNK13QGraphicsView12mapFromSceneERK9QPolygonF(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  // proto:  QPoint QGraphicsView::mapFromScene(const QPointF & point);
  fn _ZNK13QGraphicsView12mapFromSceneERK7QPointF(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  ...
  fn _ZN13QGraphicsView11resetMatrixEv(qthis: u64 /* *mut c_void*/);
  // proto:  void QGraphicsView::resetTransform();
  fn _ZN13QGraphicsView14resetTransformEv(qthis: u64 /* *mut c_void*/);
  // proto:  QPainterPath QGraphicsView::mapToScene(const QPainterPath & path);
  fn _ZNK13QGraphicsView10mapToSceneERK12QPainterPath(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  ...
  fn QGraphicsView_SlotProxy_connect__ZN13QGraphicsView17rubberBandChangedE5QRect7QPointFS1_(qthis: *mut c_void, fptr: *mut c_void);
} // <= ext block end
...
impl<'a> /*trait*/ QGraphicsView_metaObject<()> for () {
  fn metaObject(self , rsthis: & QGraphicsView) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
...
extern fn QGraphicsView_rubberBandChanged_signal_connect_cb_0(arg0: *mut c_void, arg1: *mut c_void, arg2: *mut c_void) {
  println!("{}:{}", file!(), line!());
}
impl /* trait */ QGraphicsView_rubberBandChanged_signal_connect for (extern fn(QRect, QPointF, QPointF)) {
  fn connect(self, sigthis: QGraphicsView_rubberBandChanged_signal) {
    // do smth...
    unsafe {QGraphicsView_SlotProxy_connect__ZN13QGraphicsView17rubberBandChangedE5QRect7QPointFS1_(sigthis.poi as *mut c_void, QGraphicsView_rubberBandChanged_signal_connect_cb_0 as *mut c_void)};
  }
}
// <= body block end
