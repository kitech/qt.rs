...
impl<'a> /*trait*/ QMenu_isTearOffEnabled<i8> for () {
  ...
  // proto:  bool QMenu::toolTipsVisible();
impl /*struct*/ QMenu {
  pub fn toolTipsVisible<RetType, T: QMenu_toolTipsVisible<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_toolTipsVisible<i8> for () {
  ...
  // proto:  QAction * QMenu::menuAction();
impl /*struct*/ QMenu {
  pub fn menuAction<RetType, T: QMenu_menuAction<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_menuAction<QAction> for () {
  ...
  // proto:  QAction * QMenu::addAction(const QIcon & icon, const QString & text);
impl /*struct*/ QMenu {
  pub fn addAction<RetType, T: QMenu_addAction<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_addAction<RetType> {
  ...
  // proto:  QAction * QMenu::addAction(const QIcon & icon, const QString & text);
impl<'a> /*trait*/ QMenu_addAction<QAction> for (QIcon, QString) {
  ...
  // proto:  void QMenu::triggered(QAction * action);
impl /*struct*/ QMenu {
  pub fn triggered<RetType, T: QMenu_triggered<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_triggered<RetType> {
  ...
  // proto:  void QMenu::triggered(QAction * action);
impl<'a> /*trait*/ QMenu_triggered<()> for (QAction) {
  ...
  // proto:  void QMenu::setTearOffEnabled(bool );
impl /*struct*/ QMenu {
  pub fn setTearOffEnabled<RetType, T: QMenu_setTearOffEnabled<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_setTearOffEnabled<()> for (i8) {
  ...
  // proto:  QAction * QMenu::addSection(const QString & text);
impl /*struct*/ QMenu {
  pub fn addSection<RetType, T: QMenu_addSection<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_addSection<RetType> {
  ...
  // proto:  QAction * QMenu::addSection(const QString & text);
impl<'a> /*trait*/ QMenu_addSection<QAction> for (QString) {
  ...
  // proto:  const QMetaObject * QMenu::metaObject();
impl /*struct*/ QMenu {
  pub fn metaObject<RetType, T: QMenu_metaObject<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_metaObject<()> for () {
  ...
  // proto:  void QMenu::clear();
impl /*struct*/ QMenu {
  pub fn clear<RetType, T: QMenu_clear<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_clear<()> for () {
  ...
  // proto:  QAction * QMenu::insertMenu(QAction * before, QMenu * menu);
impl /*struct*/ QMenu {
  pub fn insertMenu<RetType, T: QMenu_insertMenu<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_insertMenu<RetType> {
  ...
  // proto:  QAction * QMenu::insertMenu(QAction * before, QMenu * menu);
impl<'a> /*trait*/ QMenu_insertMenu<QAction> for (QAction, QMenu) {
  ...
  // proto:  QIcon QMenu::icon();
impl /*struct*/ QMenu {
  pub fn icon<RetType, T: QMenu_icon<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_icon<QIcon> for () {
  ...
  // proto:  QAction * QMenu::insertSection(QAction * before, const QString & text);
impl /*struct*/ QMenu {
  pub fn insertSection<RetType, T: QMenu_insertSection<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_insertSection<RetType> {
  ...
  // proto:  QAction * QMenu::insertSection(QAction * before, const QString & text);
impl<'a> /*trait*/ QMenu_insertSection<QAction> for (QAction, QString) {
  ...
  // proto:  QPlatformMenu * QMenu::platformMenu();
impl /*struct*/ QMenu {
  pub fn platformMenu<RetType, T: QMenu_platformMenu<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_platformMenu<()> for () {
  ...
  // proto:  void QMenu::setNoReplayFor(QWidget * widget);
impl /*struct*/ QMenu {
  pub fn setNoReplayFor<RetType, T: QMenu_setNoReplayFor<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_setNoReplayFor<RetType> {
  ...
  // proto:  void QMenu::setNoReplayFor(QWidget * widget);
impl<'a> /*trait*/ QMenu_setNoReplayFor<()> for (QWidget) {
  ...
  // proto:  void QMenu::setIcon(const QIcon & icon);
impl /*struct*/ QMenu {
  pub fn setIcon<RetType, T: QMenu_setIcon<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_setIcon<RetType> {
  ...
  // proto:  void QMenu::setIcon(const QIcon & icon);
impl<'a> /*trait*/ QMenu_setIcon<()> for (QIcon) {
  ...
  // proto:  QAction * QMenu::exec(const QPoint & pos, QAction * at);
impl /*struct*/ QMenu {
  pub fn exec<RetType, T: QMenu_exec<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_exec<RetType> {
  ...
  // proto:  QAction * QMenu::exec(const QPoint & pos, QAction * at);
impl<'a> /*trait*/ QMenu_exec<QAction> for (QPoint, QAction) {
  ...
  // proto:  bool QMenu::separatorsCollapsible();
impl /*struct*/ QMenu {
  pub fn separatorsCollapsible<RetType, T: QMenu_separatorsCollapsible<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_separatorsCollapsible<i8> for () {
  ...
  // proto:  QMenu * QMenu::addMenu(const QString & title);
impl /*struct*/ QMenu {
  pub fn addMenu<RetType, T: QMenu_addMenu<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_addMenu<RetType> {
  ...
  // proto:  QMenu * QMenu::addMenu(const QString & title);
impl<'a> /*trait*/ QMenu_addMenu<QMenu> for (QString) {
  ...
  // proto:  void QMenu::hovered(QAction * action);
impl /*struct*/ QMenu {
  pub fn hovered<RetType, T: QMenu_hovered<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_hovered<RetType> {
  ...
  // proto:  void QMenu::hovered(QAction * action);
impl<'a> /*trait*/ QMenu_hovered<()> for (QAction) {
  ...
  // proto:  QAction * QMenu::addSeparator();
impl /*struct*/ QMenu {
  pub fn addSeparator<RetType, T: QMenu_addSeparator<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_addSeparator<QAction> for () {
  ...
  // proto:  void QMenu::hideTearOffMenu();
impl /*struct*/ QMenu {
  pub fn hideTearOffMenu<RetType, T: QMenu_hideTearOffMenu<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_hideTearOffMenu<()> for () {
  ...
  // proto:  QAction * QMenu::addAction(const QString & text, const QObject * receiver, const char * member, const QKeySequence & shortcut);
impl<'a> /*trait*/ QMenu_addAction<QAction> for (QString, QObject, &'a  String, QKeySequence) {
  fn addAction(self , rsthis: &mut QMenu) -> QAction {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
...
pub trait QMenu_NewQMenu {
  ...
  // proto:  void QMenu::QMenu(QWidget * parent);
impl<'a> /*trait*/ QMenu_NewQMenu for (QWidget) {
  fn NewQMenu(self) -> QMenu {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QMenu::setActiveAction(QAction * act);
impl /*struct*/ QMenu {
  pub fn setActiveAction<RetType, T: QMenu_setActiveAction<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_setActiveAction<RetType> {
  ...
  // proto:  void QMenu::setActiveAction(QAction * act);
impl<'a> /*trait*/ QMenu_setActiveAction<()> for (QAction) {
  ...
  // proto:  void QMenu::setSeparatorsCollapsible(bool collapse);
impl /*struct*/ QMenu {
  pub fn setSeparatorsCollapsible<RetType, T: QMenu_setSeparatorsCollapsible<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_setSeparatorsCollapsible<()> for (i8) {
  ...
  // proto:  void QMenu::QMenu(const QMenu & );
impl<'a> /*trait*/ QMenu_NewQMenu for (QMenu) {
  fn NewQMenu(self) -> QMenu {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  QAction * QMenu::addAction(const QString & text);
impl<'a> /*trait*/ QMenu_addAction<QAction> for (QString) {
  fn addAction(self , rsthis: &mut QMenu) -> QAction {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  QAction * QMenu::activeAction();
impl /*struct*/ QMenu {
  pub fn activeAction<RetType, T: QMenu_activeAction<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_activeAction<QAction> for () {
  ...
  // proto:  bool QMenu::isEmpty();
impl /*struct*/ QMenu {
  pub fn isEmpty<RetType, T: QMenu_isEmpty<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_isEmpty<i8> for () {
  ...
  // proto:  QAction * QMenu::addAction(const QIcon & icon, const QString & text, const QObject * receiver, const char * member, const QKeySequence & shortcut);
impl<'a> /*trait*/ QMenu_addAction<QAction> for (QIcon, QString, QObject, &'a  String, QKeySequence) {
  fn addAction(self , rsthis: &mut QMenu) -> QAction {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  QRect QMenu::actionGeometry(QAction * );
impl /*struct*/ QMenu {
  pub fn actionGeometry<RetType, T: QMenu_actionGeometry<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_actionGeometry<RetType> {
  ...
  // proto:  QRect QMenu::actionGeometry(QAction * );
impl<'a> /*trait*/ QMenu_actionGeometry<QRect> for (QAction) {
  ...
  // proto:  void QMenu::QMenu(const QString & title, QWidget * parent);
impl<'a> /*trait*/ QMenu_NewQMenu for (QString, QWidget) {
  fn NewQMenu(self) -> QMenu {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  QAction * QMenu::insertSeparator(QAction * before);
impl /*struct*/ QMenu {
  pub fn insertSeparator<RetType, T: QMenu_insertSeparator<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_insertSeparator<RetType> {
  ...
  // proto:  QAction * QMenu::insertSeparator(QAction * before);
impl<'a> /*trait*/ QMenu_insertSeparator<QAction> for (QAction) {
  ...
  // proto:  void QMenu::aboutToHide();
impl /*struct*/ QMenu {
  pub fn aboutToHide<RetType, T: QMenu_aboutToHide<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_aboutToHide<()> for () {
  ...
  // proto:  QAction * QMenu::addSection(const QIcon & icon, const QString & text);
impl<'a> /*trait*/ QMenu_addSection<QAction> for (QIcon, QString) {
  fn addSection(self , rsthis: &mut QMenu) -> QAction {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  bool QMenu::isTearOffMenuVisible();
impl /*struct*/ QMenu {
  pub fn isTearOffMenuVisible<RetType, T: QMenu_isTearOffMenuVisible<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_isTearOffMenuVisible<i8> for () {
  ...
  // proto:  void QMenu::~QMenu();
impl /*struct*/ QMenu {
  pub fn FreeQMenu<RetType, T: QMenu_FreeQMenu<RetType>>(&mut self,  overload_args: T) -> RetType {
    return overload_args.FreeQMenu(self);
    // return 1;
  }
}
...
impl<'a> /*trait*/ QMenu_FreeQMenu<()> for () {
  ...
  // proto:  QString QMenu::title();
impl /*struct*/ QMenu {
  pub fn title<RetType, T: QMenu_title<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_title<QString> for () {
  ...
  // proto:  QAction * QMenu::defaultAction();
impl /*struct*/ QMenu {
  pub fn defaultAction<RetType, T: QMenu_defaultAction<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_defaultAction<QAction> for () {
  ...
  // proto:  QAction * QMenu::addMenu(QMenu * menu);
impl<'a> /*trait*/ QMenu_addMenu<QAction> for (QMenu) {
  ...
  // proto:  void QMenu::aboutToShow();
impl /*struct*/ QMenu {
  pub fn aboutToShow<RetType, T: QMenu_aboutToShow<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_aboutToShow<()> for () {
  ...
  // proto:  QSize QMenu::sizeHint();
impl /*struct*/ QMenu {
  pub fn sizeHint<RetType, T: QMenu_sizeHint<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_sizeHint<QSize> for () {
  ...
  // proto:  void QMenu::setDefaultAction(QAction * );
impl /*struct*/ QMenu {
  pub fn setDefaultAction<RetType, T: QMenu_setDefaultAction<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_setDefaultAction<RetType> {
  ...
  // proto:  void QMenu::setDefaultAction(QAction * );
impl<'a> /*trait*/ QMenu_setDefaultAction<()> for (QAction) {
  ...
  // proto:  QAction * QMenu::actionAt(const QPoint & );
impl /*struct*/ QMenu {
  pub fn actionAt<RetType, T: QMenu_actionAt<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_actionAt<RetType> {
  ...
  // proto:  QAction * QMenu::actionAt(const QPoint & );
impl<'a> /*trait*/ QMenu_actionAt<QAction> for (QPoint) {
  ...
  // proto:  QAction * QMenu::insertSection(QAction * before, const QIcon & icon, const QString & text);
impl<'a> /*trait*/ QMenu_insertSection<QAction> for (QAction, QIcon, QString) {
  fn insertSection(self , rsthis: &mut QMenu) -> QAction {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QMenu::popup(const QPoint & pos, QAction * at);
impl /*struct*/ QMenu {
  pub fn popup<RetType, T: QMenu_popup<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_popup<RetType> {
  ...
  // proto:  void QMenu::popup(const QPoint & pos, QAction * at);
impl<'a> /*trait*/ QMenu_popup<()> for (QPoint, QAction) {
  ...
  // proto:  void QMenu::setToolTipsVisible(bool visible);
impl /*struct*/ QMenu {
  pub fn setToolTipsVisible<RetType, T: QMenu_setToolTipsVisible<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QMenu_setToolTipsVisible<()> for (i8) {
  ...
  // proto:  void QMenu::setTitle(const QString & title);
impl /*struct*/ QMenu {
  pub fn setTitle<RetType, T: QMenu_setTitle<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QMenu_setTitle<RetType> {
  ...
  // proto:  void QMenu::setTitle(const QString & title);
impl<'a> /*trait*/ QMenu_setTitle<()> for (QString) {
  ...
  // proto:  QMenu * QMenu::addMenu(const QIcon & icon, const QString & title);
impl<'a> /*trait*/ QMenu_addMenu<QMenu> for (QIcon, QString) {
  fn addMenu(self , rsthis: &mut QMenu) -> QMenu {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
