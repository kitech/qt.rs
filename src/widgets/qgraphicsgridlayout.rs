...
impl<'a> /*trait*/ QGraphicsGridLayout_setRowPreferredHeight<()> for (i32, f64) {
  ...
  // proto:  int QGraphicsGridLayout::columnCount();
impl /*struct*/ QGraphicsGridLayout {
  pub fn columnCount<RetType, T: QGraphicsGridLayout_columnCount<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_columnCount<i32> for () {
  ...
  // proto:  QGraphicsLayoutItem * QGraphicsGridLayout::itemAt(int index);
impl /*struct*/ QGraphicsGridLayout {
  pub fn itemAt<RetType, T: QGraphicsGridLayout_itemAt<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_itemAt<()> for (i32) {
  ...
  // proto:  int QGraphicsGridLayout::count();
impl /*struct*/ QGraphicsGridLayout {
  pub fn count<RetType, T: QGraphicsGridLayout_count<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_count<i32> for () {
  ...
  // proto:  void QGraphicsGridLayout::setColumnFixedWidth(int column, qreal width);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setColumnFixedWidth<RetType, T: QGraphicsGridLayout_setColumnFixedWidth<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setColumnFixedWidth<()> for (i32, f64) {
  ...
  // proto:  void QGraphicsGridLayout::setColumnMaximumWidth(int column, qreal width);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setColumnMaximumWidth<RetType, T: QGraphicsGridLayout_setColumnMaximumWidth<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setColumnMaximumWidth<()> for (i32, f64) {
  ...
  // proto:  int QGraphicsGridLayout::rowStretchFactor(int row);
impl /*struct*/ QGraphicsGridLayout {
  pub fn rowStretchFactor<RetType, T: QGraphicsGridLayout_rowStretchFactor<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_rowStretchFactor<i32> for (i32) {
  ...
  // proto:  qreal QGraphicsGridLayout::verticalSpacing();
impl /*struct*/ QGraphicsGridLayout {
  pub fn verticalSpacing<RetType, T: QGraphicsGridLayout_verticalSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_verticalSpacing<f64> for () {
  ...
  // proto:  int QGraphicsGridLayout::columnStretchFactor(int column);
impl /*struct*/ QGraphicsGridLayout {
  pub fn columnStretchFactor<RetType, T: QGraphicsGridLayout_columnStretchFactor<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_columnStretchFactor<i32> for (i32) {
  ...
  // proto:  void QGraphicsGridLayout::setRowMaximumHeight(int row, qreal height);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setRowMaximumHeight<RetType, T: QGraphicsGridLayout_setRowMaximumHeight<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setRowMaximumHeight<()> for (i32, f64) {
  ...
  // proto:  void QGraphicsGridLayout::removeItem(QGraphicsLayoutItem * item);
impl /*struct*/ QGraphicsGridLayout {
  pub fn removeItem<RetType, T: QGraphicsGridLayout_removeItem<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QGraphicsGridLayout_removeItem<RetType> {
  ...
  // proto:  void QGraphicsGridLayout::removeItem(QGraphicsLayoutItem * item);
impl<'a> /*trait*/ QGraphicsGridLayout_removeItem<()> for (QGraphicsLayoutItem) {
  ...
  // proto:  void QGraphicsGridLayout::~QGraphicsGridLayout();
impl /*struct*/ QGraphicsGridLayout {
  pub fn FreeQGraphicsGridLayout<RetType, T: QGraphicsGridLayout_FreeQGraphicsGridLayout<RetType>>(&mut self,  overload_args: T) -> RetType {
    return overload_args.FreeQGraphicsGridLayout(self);
    // return 1;
  }
}
...
impl<'a> /*trait*/ QGraphicsGridLayout_FreeQGraphicsGridLayout<()> for () {
  ...
  // proto:  qreal QGraphicsGridLayout::rowMinimumHeight(int row);
impl /*struct*/ QGraphicsGridLayout {
  pub fn rowMinimumHeight<RetType, T: QGraphicsGridLayout_rowMinimumHeight<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_rowMinimumHeight<f64> for (i32) {
  ...
  // proto:  qreal QGraphicsGridLayout::rowMaximumHeight(int row);
impl /*struct*/ QGraphicsGridLayout {
  pub fn rowMaximumHeight<RetType, T: QGraphicsGridLayout_rowMaximumHeight<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QGraphicsGridLayout_NewQGraphicsGridLayout {
  ...
  // proto:  void QGraphicsGridLayout::QGraphicsGridLayout(QGraphicsLayoutItem * parent);
impl<'a> /*trait*/ QGraphicsGridLayout_NewQGraphicsGridLayout for (QGraphicsLayoutItem) {
  fn NewQGraphicsGridLayout(self) -> QGraphicsGridLayout {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QGraphicsGridLayout::setColumnSpacing(int column, qreal spacing);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setColumnSpacing<RetType, T: QGraphicsGridLayout_setColumnSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setColumnSpacing<()> for (i32, f64) {
  ...
  // proto:  qreal QGraphicsGridLayout::rowSpacing(int row);
impl /*struct*/ QGraphicsGridLayout {
  pub fn rowSpacing<RetType, T: QGraphicsGridLayout_rowSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_rowSpacing<f64> for (i32) {
  ...
  // proto:  qreal QGraphicsGridLayout::columnMaximumWidth(int column);
impl /*struct*/ QGraphicsGridLayout {
  pub fn columnMaximumWidth<RetType, T: QGraphicsGridLayout_columnMaximumWidth<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_columnMaximumWidth<f64> for (i32) {
  ...
  // proto:  void QGraphicsGridLayout::setRowFixedHeight(int row, qreal height);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setRowFixedHeight<RetType, T: QGraphicsGridLayout_setRowFixedHeight<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setRowFixedHeight<()> for (i32, f64) {
  ...
  // proto:  qreal QGraphicsGridLayout::rowPreferredHeight(int row);
impl /*struct*/ QGraphicsGridLayout {
  pub fn rowPreferredHeight<RetType, T: QGraphicsGridLayout_rowPreferredHeight<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_itemAt<()> for (i32, i32) {
  ...
  // proto:  void QGraphicsGridLayout::setVerticalSpacing(qreal spacing);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setVerticalSpacing<RetType, T: QGraphicsGridLayout_setVerticalSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setVerticalSpacing<()> for (f64) {
  ...
  // proto:  void QGraphicsGridLayout::setGeometry(const QRectF & rect);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setGeometry<RetType, T: QGraphicsGridLayout_setGeometry<RetType>>(&mut self,  overload_args: T) -> RetType {
...
pub trait QGraphicsGridLayout_setGeometry<RetType> {
  ...
  // proto:  void QGraphicsGridLayout::setGeometry(const QRectF & rect);
impl<'a> /*trait*/ QGraphicsGridLayout_setGeometry<()> for (QRectF) {
  ...
  // proto:  int QGraphicsGridLayout::rowCount();
impl /*struct*/ QGraphicsGridLayout {
  pub fn rowCount<RetType, T: QGraphicsGridLayout_rowCount<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_rowCount<i32> for () {
  ...
  // proto:  void QGraphicsGridLayout::setSpacing(qreal spacing);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setSpacing<RetType, T: QGraphicsGridLayout_setSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setSpacing<()> for (f64) {
  ...
  // proto:  void QGraphicsGridLayout::setRowStretchFactor(int row, int stretch);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setRowStretchFactor<RetType, T: QGraphicsGridLayout_setRowStretchFactor<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setRowStretchFactor<()> for (i32, i32) {
  ...
  // proto:  qreal QGraphicsGridLayout::columnMinimumWidth(int column);
impl /*struct*/ QGraphicsGridLayout {
  pub fn columnMinimumWidth<RetType, T: QGraphicsGridLayout_columnMinimumWidth<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_columnMinimumWidth<f64> for (i32) {
  ...
  // proto:  void QGraphicsGridLayout::setColumnMinimumWidth(int column, qreal width);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setColumnMinimumWidth<RetType, T: QGraphicsGridLayout_setColumnMinimumWidth<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setColumnMinimumWidth<()> for (i32, f64) {
  ...
  // proto:  void QGraphicsGridLayout::setRowMinimumHeight(int row, qreal height);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setRowMinimumHeight<RetType, T: QGraphicsGridLayout_setRowMinimumHeight<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setRowMinimumHeight<()> for (i32, f64) {
  ...
  // proto:  void QGraphicsGridLayout::setHorizontalSpacing(qreal spacing);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setHorizontalSpacing<RetType, T: QGraphicsGridLayout_setHorizontalSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setHorizontalSpacing<()> for (f64) {
  ...
  // proto:  qreal QGraphicsGridLayout::horizontalSpacing();
impl /*struct*/ QGraphicsGridLayout {
  pub fn horizontalSpacing<RetType, T: QGraphicsGridLayout_horizontalSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_horizontalSpacing<f64> for () {
  ...
  // proto:  void QGraphicsGridLayout::setColumnStretchFactor(int column, int stretch);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setColumnStretchFactor<RetType, T: QGraphicsGridLayout_setColumnStretchFactor<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setColumnStretchFactor<()> for (i32, i32) {
  ...
  // proto:  void QGraphicsGridLayout::invalidate();
impl /*struct*/ QGraphicsGridLayout {
  pub fn invalidate<RetType, T: QGraphicsGridLayout_invalidate<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_invalidate<()> for () {
  ...
  // proto:  qreal QGraphicsGridLayout::columnPreferredWidth(int column);
impl /*struct*/ QGraphicsGridLayout {
  pub fn columnPreferredWidth<RetType, T: QGraphicsGridLayout_columnPreferredWidth<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_columnPreferredWidth<f64> for (i32) {
  ...
  // proto:  void QGraphicsGridLayout::setColumnPreferredWidth(int column, qreal width);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setColumnPreferredWidth<RetType, T: QGraphicsGridLayout_setColumnPreferredWidth<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setColumnPreferredWidth<()> for (i32, f64) {
  ...
  // proto:  qreal QGraphicsGridLayout::columnSpacing(int column);
impl /*struct*/ QGraphicsGridLayout {
  pub fn columnSpacing<RetType, T: QGraphicsGridLayout_columnSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_columnSpacing<f64> for (i32) {
  ...
  // proto:  void QGraphicsGridLayout::QGraphicsGridLayout(const QGraphicsGridLayout & );
impl<'a> /*trait*/ QGraphicsGridLayout_NewQGraphicsGridLayout for (QGraphicsGridLayout) {
  fn NewQGraphicsGridLayout(self) -> QGraphicsGridLayout {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
  ...
  // proto:  void QGraphicsGridLayout::setRowSpacing(int row, qreal spacing);
impl /*struct*/ QGraphicsGridLayout {
  pub fn setRowSpacing<RetType, T: QGraphicsGridLayout_setRowSpacing<RetType>>(&mut self,  overload_args: T) -> RetType {
...
impl<'a> /*trait*/ QGraphicsGridLayout_setRowSpacing<()> for (i32, f64) {
  ...
  // proto:  void QGraphicsGridLayout::removeAt(int index);
impl /*struct*/ QGraphicsGridLayout {
  pub fn removeAt<RetType, T: QGraphicsGridLayout_removeAt<RetType>>(&mut self,  overload_args: T) -> RetType {
