...
impl<'a> /*trait*/ QListWidgetItem_isHidden<i8> for () {
  fn isHidden(self , rsthis: & QListWidgetItem) -> i8 {
    ...
    let mut ret = unsafe {demth_ZNK15QListWidgetItem8isHiddenEv(rsthis.qclsinst)};
    return ret as i8;
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setBackground<()> for (&'a QBrush) {
  fn setBackground(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem13setBackgroundERK6QBrush(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setSelected<()> for (i8) {
  fn setSelected(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self  as c_char;
     unsafe {demth_ZN15QListWidgetItem11setSelectedEb(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setTextAlignment<()> for (i32) {
  fn setTextAlignment(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {demth_ZN15QListWidgetItem16setTextAlignmentEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_type_<i32> for () {
  fn type_(self , rsthis: & QListWidgetItem) -> i32 {
    ...
    let mut ret = unsafe {demth_ZNK15QListWidgetItem4typeEv(rsthis.qclsinst)};
    return ret as i32;
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setStatusTip<()> for (&'a QString) {
  fn setStatusTip(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem12setStatusTipERK7QString(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_isSelected<i8> for () {
  fn isSelected(self , rsthis: & QListWidgetItem) -> i8 {
    ...
    let mut ret = unsafe {demth_ZNK15QListWidgetItem10isSelectedEv(rsthis.qclsinst)};
    return ret as i8;
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setFont<()> for (&'a QFont) {
  fn setFont(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem7setFontERK5QFont(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setText<()> for (&'a QString) {
  fn setText(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem7setTextERK7QString(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setWhatsThis<()> for (&'a QString) {
  fn setWhatsThis(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem12setWhatsThisERK7QString(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setTextColor<()> for (&'a QColor) {
  fn setTextColor(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem12setTextColorERK6QColor(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setSizeHint<()> for (&'a QSize) {
  fn setSizeHint(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem11setSizeHintERK5QSize(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setIcon<()> for (&'a QIcon) {
  fn setIcon(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem7setIconERK5QIcon(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setBackgroundColor<()> for (&'a QColor) {
  fn setBackgroundColor(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem18setBackgroundColorERK6QColor(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setForeground<()> for (&'a QBrush) {
  fn setForeground(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem13setForegroundERK6QBrush(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setHidden<()> for (i8) {
  fn setHidden(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self  as c_char;
     unsafe {demth_ZN15QListWidgetItem9setHiddenEb(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_textAlignment<i32> for () {
  fn textAlignment(self , rsthis: & QListWidgetItem) -> i32 {
    ...
    let mut ret = unsafe {demth_ZNK15QListWidgetItem13textAlignmentEv(rsthis.qclsinst)};
    return ret as i32;
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidgetItem_setToolTip<()> for (&'a QString) {
  fn setToolTip(self , rsthis: & QListWidgetItem) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN15QListWidgetItem10setToolTipERK7QString(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidget_addItem<()> for (&'a QListWidgetItem) {
  fn addItem(self , rsthis: & QListWidget) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN11QListWidget7addItemEP15QListWidgetItem(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidget_addItems<()> for (&'a QStringList) {
  fn addItems(self , rsthis: & QListWidget) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN11QListWidget8addItemsERK11QStringList(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidget_removeItemWidget<()> for (&'a QListWidgetItem) {
  fn removeItemWidget(self , rsthis: & QListWidget) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN11QListWidget16removeItemWidgetEP15QListWidgetItem(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QListWidget_addItem<()> for (&'a QString) {
  fn addItem(self , rsthis: & QListWidget) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {demth_ZN11QListWidget7addItemERK7QString(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
extern fn QListWidget_itemDoubleClicked_signal_connect_cb_box_0(rsfptr_raw:*mut fn(QListWidgetItem), arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
...
extern fn QListWidget_itemEntered_signal_connect_cb_box_1(rsfptr_raw:*mut fn(QListWidgetItem), arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QListWidgetItem::inheritFrom(arg0 as u64);
  rsfptr(rsarg0);
...
extern fn QListWidget_itemClicked_signal_connect_cb_box_2(rsfptr_raw:*mut fn(QListWidgetItem), arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QListWidgetItem::inheritFrom(arg0 as u64);
  rsfptr(rsarg0);
...
extern fn QListWidget_currentItemChanged_signal_connect_cb_box_3(rsfptr_raw:*mut fn(QListWidgetItem, QListWidgetItem), arg0: *mut c_void, arg1: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QListWidgetItem::inheritFrom(arg0 as u64);
  let rsarg1 = QListWidgetItem::inheritFrom(arg1 as u64);
...
extern fn QListWidget_currentTextChanged_signal_connect_cb_box_4(rsfptr_raw:*mut fn(QString), arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QString::inheritFrom(arg0 as u64);
  rsfptr(rsarg0);
...
extern fn QListWidget_itemChanged_signal_connect_cb_box_5(rsfptr_raw:*mut fn(QListWidgetItem), arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QListWidgetItem::inheritFrom(arg0 as u64);
  rsfptr(rsarg0);
...
extern fn QListWidget_itemSelectionChanged_signal_connect_cb_box_6(rsfptr_raw:*mut fn(), ) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  rsfptr();
}
...
extern fn QListWidget_itemPressed_signal_connect_cb_box_7(rsfptr_raw:*mut fn(QListWidgetItem), arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QListWidgetItem::inheritFrom(arg0 as u64);
  rsfptr(rsarg0);
...
extern fn QListWidget_itemActivated_signal_connect_cb_box_8(rsfptr_raw:*mut fn(QListWidgetItem), arg0: *mut c_void) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = QListWidgetItem::inheritFrom(arg0 as u64);
  rsfptr(rsarg0);
...
extern fn QListWidget_currentRowChanged_signal_connect_cb_box_9(rsfptr_raw:*mut fn(i32), arg0: c_int) {
  println!("{}:{}", file!(), line!());
  let rsfptr = unsafe{Box::from_raw(rsfptr_raw)};
  let rsarg0 = arg0 as i32;
  rsfptr(rsarg0);
