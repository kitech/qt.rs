...
extern {
  ...
  fn C_ZN10QTableView20resizeRowsToContentsEv(qthis: u64 /* *mut c_void*/);
  // proto:  void QTableView::setRowHeight(int row, int height);
  fn C_ZN10QTableView12setRowHeightEii(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int);
  // proto:  QHeaderView * QTableView::verticalHeader();
  fn C_ZNK10QTableView14verticalHeaderEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  void QTableView::setSpan(int row, int column, int rowSpan, int columnSpan);
  fn C_ZN10QTableView7setSpanEiiii(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int, arg2: c_int, arg3: c_int);
  // proto:  void QTableView::setSortingEnabled(bool enable);
  fn C_ZN10QTableView17setSortingEnabledEb(qthis: u64 /* *mut c_void*/, arg0: c_char);
  // proto:  void QTableView::setColumnWidth(int column, int width);
  fn C_ZN10QTableView14setColumnWidthEii(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int);
  // proto:  void QTableView::setWordWrap(bool on);
  fn C_ZN10QTableView11setWordWrapEb(qthis: u64 /* *mut c_void*/, arg0: c_char);
  // proto:  void QTableView::doItemsLayout();
  fn C_ZN10QTableView13doItemsLayoutEv(qthis: u64 /* *mut c_void*/);
  // proto:  void QTableView::setSelectionModel(QItemSelectionModel * selectionModel);
  fn C_ZN10QTableView17setSelectionModelEP19QItemSelectionModel(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  void QTableView::setHorizontalHeader(QHeaderView * header);
  fn C_ZN10QTableView19setHorizontalHeaderEP11QHeaderView(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  void QTableView::setRowHidden(int row, bool hide);
  fn C_ZN10QTableView12setRowHiddenEib(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_char);
  // proto:  int QTableView::rowViewportPosition(int row);
  fn C_ZNK10QTableView19rowViewportPositionEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_int;
  // proto:  int QTableView::columnAt(int x);
  fn C_ZNK10QTableView8columnAtEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_int;
  // proto:  bool QTableView::isRowHidden(int row);
  fn C_ZNK10QTableView11isRowHiddenEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_char;
  // proto:  void QTableView::showColumn(int column);
  fn C_ZN10QTableView10showColumnEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  void QTableView::resizeRowToContents(int row);
  fn C_ZN10QTableView19resizeRowToContentsEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  void QTableView::setRootIndex(const QModelIndex & index);
  fn C_ZN10QTableView12setRootIndexERK11QModelIndex(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  void QTableView::setColumnHidden(int column, bool hide);
  fn C_ZN10QTableView15setColumnHiddenEib(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_char);
  // proto:  void QTableView::hideRow(int row);
  fn C_ZN10QTableView7hideRowEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  void QTableView::resizeColumnsToContents();
  fn C_ZN10QTableView23resizeColumnsToContentsEv(qthis: u64 /* *mut c_void*/);
  // proto:  bool QTableView::wordWrap();
  fn C_ZNK10QTableView8wordWrapEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  void QTableView::setShowGrid(bool show);
  fn C_ZN10QTableView11setShowGridEb(qthis: u64 /* *mut c_void*/, arg0: c_char);
  // proto:  bool QTableView::isColumnHidden(int column);
  fn C_ZNK10QTableView14isColumnHiddenEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_char;
  // proto:  void QTableView::selectRow(int row);
  fn C_ZN10QTableView9selectRowEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  const QMetaObject * QTableView::metaObject();
  fn C_ZNK10QTableView10metaObjectEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  bool QTableView::isCornerButtonEnabled();
  fn C_ZNK10QTableView21isCornerButtonEnabledEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  void QTableView::selectColumn(int column);
  fn C_ZN10QTableView12selectColumnEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  void QTableView::~QTableView();
  fn C_ZN10QTableViewD2Ev(qthis: u64 /* *mut c_void*/);
  // proto:  void QTableView::resizeColumnToContents(int column);
  fn C_ZN10QTableView22resizeColumnToContentsEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  void QTableView::QTableView(QWidget * parent);
  fn C_ZN10QTableViewC2EP7QWidget(arg0: *mut c_void) -> u64;
  // proto:  void QTableView::sortByColumn(int column);
  fn C_ZN10QTableView12sortByColumnEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  int QTableView::columnSpan(int row, int column);
  fn C_ZNK10QTableView10columnSpanEii(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int) -> c_int;
  // proto:  int QTableView::columnWidth(int column);
  fn C_ZNK10QTableView11columnWidthEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_int;
  // proto:  int QTableView::columnViewportPosition(int column);
  fn C_ZNK10QTableView22columnViewportPositionEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_int;
  // proto:  int QTableView::rowHeight(int row);
  fn C_ZNK10QTableView9rowHeightEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_int;
  // proto:  int QTableView::rowAt(int y);
  fn C_ZNK10QTableView5rowAtEi(qthis: u64 /* *mut c_void*/, arg0: c_int) -> c_int;
  // proto:  int QTableView::rowSpan(int row, int column);
  fn C_ZNK10QTableView7rowSpanEii(qthis: u64 /* *mut c_void*/, arg0: c_int, arg1: c_int) -> c_int;
  // proto:  void QTableView::setCornerButtonEnabled(bool enable);
  fn C_ZN10QTableView22setCornerButtonEnabledEb(qthis: u64 /* *mut c_void*/, arg0: c_char);
  // proto:  QRect QTableView::visualRect(const QModelIndex & index);
  fn C_ZNK10QTableView10visualRectERK11QModelIndex(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  // proto:  QModelIndex QTableView::indexAt(const QPoint & p);
  fn C_ZNK10QTableView7indexAtERK6QPoint(qthis: u64 /* *mut c_void*/, arg0: *mut c_void) -> *mut c_void;
  // proto:  QHeaderView * QTableView::horizontalHeader();
  fn C_ZNK10QTableView16horizontalHeaderEv(qthis: u64 /* *mut c_void*/) -> *mut c_void;
  // proto:  void QTableView::setModel(QAbstractItemModel * model);
  fn C_ZN10QTableView8setModelEP18QAbstractItemModel(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  bool QTableView::isSortingEnabled();
  fn C_ZNK10QTableView16isSortingEnabledEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  void QTableView::clearSpans();
  fn C_ZN10QTableView10clearSpansEv(qthis: u64 /* *mut c_void*/);
  // proto:  void QTableView::setVerticalHeader(QHeaderView * header);
  fn C_ZN10QTableView17setVerticalHeaderEP11QHeaderView(qthis: u64 /* *mut c_void*/, arg0: *mut c_void);
  // proto:  bool QTableView::showGrid();
  fn C_ZNK10QTableView8showGridEv(qthis: u64 /* *mut c_void*/) -> c_char;
  // proto:  void QTableView::showRow(int row);
  fn C_ZN10QTableView7showRowEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
  // proto:  void QTableView::hideColumn(int column);
  fn C_ZN10QTableView10hideColumnEi(qthis: u64 /* *mut c_void*/, arg0: c_int);
} // <= ext block end
...
impl<'a> /*trait*/ QTableView_resizeRowsToContents<()> for () {
  fn resizeRowsToContents(self , rsthis: & QTableView) -> () {
    ...
    // unsafe{_ZN10QTableView20resizeRowsToContentsEv()};
     unsafe {C_ZN10QTableView20resizeRowsToContentsEv(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setRowHeight<()> for (i32, i32) {
  fn setRowHeight(self , rsthis: & QTableView) -> () {
    ...
    let arg1 = self.1  as c_int;
     unsafe {C_ZN10QTableView12setRowHeightEii(rsthis.qclsinst, arg0, arg1)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_verticalHeader<QHeaderView> for () {
  fn verticalHeader(self , rsthis: & QTableView) -> QHeaderView {
    ...
    let mut ret = unsafe {C_ZNK10QTableView14verticalHeaderEv(rsthis.qclsinst)};
...
impl<'a> /*trait*/ QTableView_setSpan<()> for (i32, i32, i32, i32) {
  fn setSpan(self , rsthis: & QTableView) -> () {
    ...
    let arg3 = self.3  as c_int;
     unsafe {C_ZN10QTableView7setSpanEiiii(rsthis.qclsinst, arg0, arg1, arg2, arg3)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setSortingEnabled<()> for (i8) {
  fn setSortingEnabled(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_char;
     unsafe {C_ZN10QTableView17setSortingEnabledEb(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setColumnWidth<()> for (i32, i32) {
  fn setColumnWidth(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self.0  as c_int;
    let arg1 = self.1  as c_int;
     unsafe {C_ZN10QTableView14setColumnWidthEii(rsthis.qclsinst, arg0, arg1)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setWordWrap<()> for (i8) {
  fn setWordWrap(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_char;
     unsafe {C_ZN10QTableView11setWordWrapEb(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_doItemsLayout<()> for () {
  fn doItemsLayout(self , rsthis: & QTableView) -> () {
    ...
    // unsafe{_ZN10QTableView13doItemsLayoutEv()};
     unsafe {C_ZN10QTableView13doItemsLayoutEv(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setSelectionModel<()> for (&'a QItemSelectionModel) {
  fn setSelectionModel(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {C_ZN10QTableView17setSelectionModelEP19QItemSelectionModel(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setHorizontalHeader<()> for (&'a QHeaderView) {
  fn setHorizontalHeader(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {C_ZN10QTableView19setHorizontalHeaderEP11QHeaderView(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setRowHidden<()> for (i32, i8) {
  fn setRowHidden(self , rsthis: & QTableView) -> () {
    ...
    let arg1 = self.1  as c_char;
     unsafe {C_ZN10QTableView12setRowHiddenEib(rsthis.qclsinst, arg0, arg1)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_rowViewportPosition<i32> for (i32) {
  fn rowViewportPosition(self , rsthis: & QTableView) -> i32 {
    ...
    let mut ret = unsafe {C_ZNK10QTableView19rowViewportPositionEi(rsthis.qclsinst, arg0)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_columnAt<i32> for (i32) {
  fn columnAt(self , rsthis: & QTableView) -> i32 {
    ...
    let arg0 = self  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView8columnAtEi(rsthis.qclsinst, arg0)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_isRowHidden<i8> for (i32) {
  fn isRowHidden(self , rsthis: & QTableView) -> i8 {
    ...
    let arg0 = self  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView11isRowHiddenEi(rsthis.qclsinst, arg0)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_showColumn<()> for (i32) {
  fn showColumn(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView10showColumnEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_resizeRowToContents<()> for (i32) {
  fn resizeRowToContents(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView19resizeRowToContentsEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setRootIndex<()> for (&'a QModelIndex) {
  fn setRootIndex(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {C_ZN10QTableView12setRootIndexERK11QModelIndex(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setColumnHidden<()> for (i32, i8) {
  fn setColumnHidden(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self.0  as c_int;
    let arg1 = self.1  as c_char;
     unsafe {C_ZN10QTableView15setColumnHiddenEib(rsthis.qclsinst, arg0, arg1)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_hideRow<()> for (i32) {
  fn hideRow(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView7hideRowEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_resizeColumnsToContents<()> for () {
  fn resizeColumnsToContents(self , rsthis: & QTableView) -> () {
    ...
    // unsafe{_ZN10QTableView23resizeColumnsToContentsEv()};
     unsafe {C_ZN10QTableView23resizeColumnsToContentsEv(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_wordWrap<i8> for () {
  fn wordWrap(self , rsthis: & QTableView) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK10QTableView8wordWrapEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setShowGrid<()> for (i8) {
  fn setShowGrid(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_char;
     unsafe {C_ZN10QTableView11setShowGridEb(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_isColumnHidden<i8> for (i32) {
  fn isColumnHidden(self , rsthis: & QTableView) -> i8 {
    ...
    let arg0 = self  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView14isColumnHiddenEi(rsthis.qclsinst, arg0)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_selectRow<()> for (i32) {
  fn selectRow(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView9selectRowEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
pub trait QTableView_metaObject<RetType> {
  ...
  // proto:  const QMetaObject * QTableView::metaObject();
impl<'a> /*trait*/ QTableView_metaObject<QMetaObject> for () {
  fn metaObject(self , rsthis: & QTableView) -> QMetaObject {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
    // unsafe{_ZNK10QTableView10metaObjectEv()};
    let mut ret = unsafe {C_ZNK10QTableView10metaObjectEv(rsthis.qclsinst)};
...
impl<'a> /*trait*/ QTableView_isCornerButtonEnabled<i8> for () {
  fn isCornerButtonEnabled(self , rsthis: & QTableView) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK10QTableView21isCornerButtonEnabledEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_selectColumn<()> for (i32) {
  fn selectColumn(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView12selectColumnEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_free<()> for () {
  fn free(self , rsthis: & QTableView) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
    // unsafe{_ZN10QTableViewD2Ev()};
     unsafe {C_ZN10QTableViewD2Ev(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_resizeColumnToContents<()> for (i32) {
  fn resizeColumnToContents(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView22resizeColumnToContentsEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
pub trait QTableView_new {
  ...
  // proto:  void QTableView::QTableView(QWidget * parent);
impl<'a> /*trait*/ QTableView_new for (Option<&'a QWidget>) {
  fn new(self) -> QTableView {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
    ...
    let qthis: u64 = unsafe {C_ZN10QTableViewC2EP7QWidget(arg0)};
...
impl<'a> /*trait*/ QTableView_sortByColumn<()> for (i32) {
  fn sortByColumn(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView12sortByColumnEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_columnSpan<i32> for (i32, i32) {
  fn columnSpan(self , rsthis: & QTableView) -> i32 {
    ...
    let arg0 = self.0  as c_int;
    let arg1 = self.1  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView10columnSpanEii(rsthis.qclsinst, arg0, arg1)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_columnWidth<i32> for (i32) {
  fn columnWidth(self , rsthis: & QTableView) -> i32 {
    ...
    let arg0 = self  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView11columnWidthEi(rsthis.qclsinst, arg0)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_columnViewportPosition<i32> for (i32) {
  fn columnViewportPosition(self , rsthis: & QTableView) -> i32 {
    ...
    let arg0 = self  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView22columnViewportPositionEi(rsthis.qclsinst, arg0)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_rowHeight<i32> for (i32) {
  fn rowHeight(self , rsthis: & QTableView) -> i32 {
    ...
    let arg0 = self  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView9rowHeightEi(rsthis.qclsinst, arg0)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_rowAt<i32> for (i32) {
  fn rowAt(self , rsthis: & QTableView) -> i32 {
    ...
    let arg0 = self  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView5rowAtEi(rsthis.qclsinst, arg0)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_rowSpan<i32> for (i32, i32) {
  fn rowSpan(self , rsthis: & QTableView) -> i32 {
    ...
    let arg0 = self.0  as c_int;
    let arg1 = self.1  as c_int;
    let mut ret = unsafe {C_ZNK10QTableView7rowSpanEii(rsthis.qclsinst, arg0, arg1)};
    return ret as i32; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setCornerButtonEnabled<()> for (i8) {
  fn setCornerButtonEnabled(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_char;
     unsafe {C_ZN10QTableView22setCornerButtonEnabledEb(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_visualRect<QRect> for (&'a QModelIndex) {
  fn visualRect(self , rsthis: & QTableView) -> QRect {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
    let mut ret = unsafe {C_ZNK10QTableView10visualRectERK11QModelIndex(rsthis.qclsinst, arg0)};
...
impl<'a> /*trait*/ QTableView_indexAt<QModelIndex> for (&'a QPoint) {
  fn indexAt(self , rsthis: & QTableView) -> QModelIndex {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
    let mut ret = unsafe {C_ZNK10QTableView7indexAtERK6QPoint(rsthis.qclsinst, arg0)};
...
impl<'a> /*trait*/ QTableView_horizontalHeader<QHeaderView> for () {
  fn horizontalHeader(self , rsthis: & QTableView) -> QHeaderView {
    ...
    let mut ret = unsafe {C_ZNK10QTableView16horizontalHeaderEv(rsthis.qclsinst)};
    let mut ret1 = QHeaderView::inheritFrom(ret as u64);
    return ret1;
    // return 1;
  }
...
impl<'a> /*trait*/ QTableView_setModel<()> for (&'a QAbstractItemModel) {
  fn setModel(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {C_ZN10QTableView8setModelEP18QAbstractItemModel(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_isSortingEnabled<i8> for () {
  fn isSortingEnabled(self , rsthis: & QTableView) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK10QTableView16isSortingEnabledEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_clearSpans<()> for () {
  fn clearSpans(self , rsthis: & QTableView) -> () {
    ...
    // unsafe{_ZN10QTableView10clearSpansEv()};
     unsafe {C_ZN10QTableView10clearSpansEv(rsthis.qclsinst)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_setVerticalHeader<()> for (&'a QHeaderView) {
  fn setVerticalHeader(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self.qclsinst  as *mut c_void;
     unsafe {C_ZN10QTableView17setVerticalHeaderEP11QHeaderView(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_showGrid<i8> for () {
  fn showGrid(self , rsthis: & QTableView) -> i8 {
    ...
    let mut ret = unsafe {C_ZNK10QTableView8showGridEv(rsthis.qclsinst)};
    return ret as i8; // 1
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_showRow<()> for (i32) {
  fn showRow(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView7showRowEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
...
impl<'a> /*trait*/ QTableView_hideColumn<()> for (i32) {
  fn hideColumn(self , rsthis: & QTableView) -> () {
    ...
    let arg0 = self  as c_int;
     unsafe {C_ZN10QTableView10hideColumnEi(rsthis.qclsinst, arg0)};
    // return 1;
  }
}
