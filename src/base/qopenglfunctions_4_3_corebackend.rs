...
// proto: void QOpenGLFunctions_4_3_CoreBackend::NewQOpenGLFunctions_4_3_CoreBackend(QOpenGLContext * context);
impl<'a> /*trait*/ QOpenGLFunctions_4_3_CoreBackend_NewQOpenGLFunctions_4_3_CoreBackend for (&'a mut QOpenGLContext) {
  fn NewQOpenGLFunctions_4_3_CoreBackend(self) -> QOpenGLFunctions_4_3_CoreBackend {
    ...
    let rsthis = QOpenGLFunctions_4_3_CoreBackend{qclsinst: qthis};
    return rsthis;
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLFunctions_4_3_CoreBackend {
  pub fn versionStatus<RetType, T: QOpenGLFunctions_4_3_CoreBackend_versionStatus<RetType>>(&mut self, value: T) -> RetType {
    return value.versionStatus(self);
    // return 1;
  }
}

pub trait QOpenGLFunctions_4_3_CoreBackend_versionStatus<RetType> {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_4_3_CoreBackend) -> RetType;
}
