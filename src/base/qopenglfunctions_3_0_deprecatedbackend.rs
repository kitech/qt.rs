...
extern {
  ...
  fn _ZN38QOpenGLFunctions_3_0_DeprecatedBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
  // proto: QOpenGLVersionStatus QOpenGLFunctions_3_0_DeprecatedBackend::versionStatus();
  fn _ZN38QOpenGLFunctions_3_0_DeprecatedBackend13versionStatusEv() -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_3_0_DeprecatedBackend {
  pub fn versionStatus<T: QOpenGLFunctions_3_0_DeprecatedBackend_versionStatus>(&mut self, value: T) -> i32 {
...
pub trait QOpenGLFunctions_3_0_DeprecatedBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_3_0_DeprecatedBackend) -> i32;
}
