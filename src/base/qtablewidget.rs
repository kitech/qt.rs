...
impl /*struct*/ QTableWidget {
  pub fn itemActivated<RetType, T: QTableWidget_itemActivated<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setColumnCount<RetType, T: QTableWidget_setColumnCount<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn FreeQTableWidget<RetType, T: QTableWidget_FreeQTableWidget<RetType>>(&mut self, value: T) -> RetType {
    return value.FreeQTableWidget(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn itemDoubleClicked<RetType, T: QTableWidget_itemDoubleClicked<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn cellChanged<RetType, T: QTableWidget_cellChanged<RetType>>(&mut self, value: T) -> RetType {
    return value.cellChanged(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn selectedItems<RetType, T: QTableWidget_selectedItems<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn isSortingEnabled<RetType, T: QTableWidget_isSortingEnabled<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn metaObject<RetType, T: QTableWidget_metaObject<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn closePersistentEditor<RetType, T: QTableWidget_closePersistentEditor<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setHorizontalHeaderLabels<RetType, T: QTableWidget_setHorizontalHeaderLabels<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn itemSelectionChanged<RetType, T: QTableWidget_itemSelectionChanged<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setItemSelected<RetType, T: QTableWidget_setItemSelected<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn takeItem<RetType, T: QTableWidget_takeItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn itemChanged<RetType, T: QTableWidget_itemChanged<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn removeCellWidget<RetType, T: QTableWidget_removeCellWidget<RetType>>(&mut self, value: T) -> RetType {
    return value.removeCellWidget(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn setVerticalHeaderItem<RetType, T: QTableWidget_setVerticalHeaderItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn cellClicked<RetType, T: QTableWidget_cellClicked<RetType>>(&mut self, value: T) -> RetType {
    return value.cellClicked(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn visualItemRect<RetType, T: QTableWidget_visualItemRect<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn currentItem<RetType, T: QTableWidget_currentItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn row<RetType, T: QTableWidget_row<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn removeRow<RetType, T: QTableWidget_removeRow<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setItemPrototype<RetType, T: QTableWidget_setItemPrototype<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn visualRow<RetType, T: QTableWidget_visualRow<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn cellEntered<RetType, T: QTableWidget_cellEntered<RetType>>(&mut self, value: T) -> RetType {
    return value.cellEntered(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn setCellWidget<RetType, T: QTableWidget_setCellWidget<RetType>>(&mut self, value: T) -> RetType {
    return value.setCellWidget(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn openPersistentEditor<RetType, T: QTableWidget_openPersistentEditor<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn columnCount<RetType, T: QTableWidget_columnCount<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn currentRow<RetType, T: QTableWidget_currentRow<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn currentItemChanged<RetType, T: QTableWidget_currentItemChanged<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setCurrentItem<RetType, T: QTableWidget_setCurrentItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn cellWidget<RetType, T: QTableWidget_cellWidget<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setSortingEnabled<RetType, T: QTableWidget_setSortingEnabled<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setItem<RetType, T: QTableWidget_setItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn horizontalHeaderItem<RetType, T: QTableWidget_horizontalHeaderItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn cellPressed<RetType, T: QTableWidget_cellPressed<RetType>>(&mut self, value: T) -> RetType {
    return value.cellPressed(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn editItem<RetType, T: QTableWidget_editItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn selectedRanges<RetType, T: QTableWidget_selectedRanges<RetType>>(&mut self, value: T) -> RetType {
    return value.selectedRanges(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn currentColumn<RetType, T: QTableWidget_currentColumn<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn removeColumn<RetType, T: QTableWidget_removeColumn<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setRangeSelected<RetType, T: QTableWidget_setRangeSelected<RetType>>(&mut self, value: T) -> RetType {
    return value.setRangeSelected(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn column<RetType, T: QTableWidget_column<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn isItemSelected<RetType, T: QTableWidget_isItemSelected<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn takeVerticalHeaderItem<RetType, T: QTableWidget_takeVerticalHeaderItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn currentCellChanged<RetType, T: QTableWidget_currentCellChanged<RetType>>(&mut self, value: T) -> RetType {
    return value.currentCellChanged(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn cellDoubleClicked<RetType, T: QTableWidget_cellDoubleClicked<RetType>>(&mut self, value: T) -> RetType {
    return value.cellDoubleClicked(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn rowCount<RetType, T: QTableWidget_rowCount<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn item<RetType, T: QTableWidget_item<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setVerticalHeaderLabels<RetType, T: QTableWidget_setVerticalHeaderLabels<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn itemPrototype<RetType, T: QTableWidget_itemPrototype<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn itemAt<RetType, T: QTableWidget_itemAt<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn clearContents<RetType, T: QTableWidget_clearContents<RetType>>(&mut self, value: T) -> RetType {
    return value.clearContents(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn itemPressed<RetType, T: QTableWidget_itemPressed<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setCurrentCell<RetType, T: QTableWidget_setCurrentCell<RetType>>(&mut self, value: T) -> RetType {
    return value.setCurrentCell(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn setRowCount<RetType, T: QTableWidget_setRowCount<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn setHorizontalHeaderItem<RetType, T: QTableWidget_setHorizontalHeaderItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn visualColumn<RetType, T: QTableWidget_visualColumn<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn itemEntered<RetType, T: QTableWidget_itemEntered<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn takeHorizontalHeaderItem<RetType, T: QTableWidget_takeHorizontalHeaderItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn verticalHeaderItem<RetType, T: QTableWidget_verticalHeaderItem<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn clear<RetType, T: QTableWidget_clear<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn insertColumn<RetType, T: QTableWidget_insertColumn<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableWidget {
  pub fn cellActivated<RetType, T: QTableWidget_cellActivated<RetType>>(&mut self, value: T) -> RetType {
    return value.cellActivated(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableWidget {
  pub fn itemClicked<RetType, T: QTableWidget_itemClicked<RetType>>(&mut self, value: T) -> RetType {
