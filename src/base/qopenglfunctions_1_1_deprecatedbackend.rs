...
impl /*struct*/ QOpenGLFunctions_1_1_DeprecatedBackend {
  pub fn versionStatus<RetType, T: QOpenGLFunctions_1_1_DeprecatedBackend_versionStatus<RetType>>(&mut self, value: T) -> RetType {
    return value.versionStatus(self);
    // return 1;
  }
}

pub trait QOpenGLFunctions_1_1_DeprecatedBackend_versionStatus<RetType> {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_1_1_DeprecatedBackend) -> RetType;
}

// proto: static QOpenGLVersionStatus QOpenGLFunctions_1_1_DeprecatedBackend::versionStatus();
impl<'a> /*trait*/ QOpenGLFunctions_1_1_DeprecatedBackend_versionStatus<()> for () {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_1_1_DeprecatedBackend) -> () {
