...
impl /*struct*/ QAccessiblePlugin {
  pub fn metaObject<T: QAccessiblePlugin_metaObject>(&mut self, value: T)  {
...
impl /*struct*/ QAccessiblePlugin {
  pub fn FreeQAccessiblePlugin<T: QAccessiblePlugin_FreeQAccessiblePlugin>(&mut self, value: T)  {
...
impl /*struct*/ QAccessiblePlugin {
  pub fn create<T: QAccessiblePlugin_create>(&mut self, value: T) -> QAccessibleInterface {
