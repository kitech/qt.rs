...
extern {
  // proto: QOpenGLVersionStatus QOpenGLFunctions_4_0_CoreBackend::versionStatus();
  fn _ZN32QOpenGLFunctions_4_0_CoreBackend13versionStatusEv() -> i32;
  // proto: void QOpenGLFunctions_4_0_CoreBackend::NewQOpenGLFunctions_4_0_CoreBackend(QOpenGLContext * context);
  fn _ZN32QOpenGLFunctions_4_0_CoreBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_4_0_CoreBackend {
  pub fn versionStatus<T: QOpenGLFunctions_4_0_CoreBackend_versionStatus>(&mut self, value: T) -> i32 {
    value.versionStatus(self);
    return 1;
  }
}

pub trait QOpenGLFunctions_4_0_CoreBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_4_0_CoreBackend) -> i32;
}
