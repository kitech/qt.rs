...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn isLinked<RetType, T: QOpenGLShaderProgram_isLinked<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn setUniformValue<RetType, T: QOpenGLShaderProgram_setUniformValue<RetType>>(&mut self, value: T) -> RetType {
    return value.setUniformValue(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn setAttributeValue<RetType, T: QOpenGLShaderProgram_setAttributeValue<RetType>>(&mut self, value: T) -> RetType {
    return value.setAttributeValue(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn setUniformValueArray<RetType, T: QOpenGLShaderProgram_setUniformValueArray<RetType>>(&mut self, value: T) -> RetType {
    return value.setUniformValueArray(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn setAttributeBuffer<RetType, T: QOpenGLShaderProgram_setAttributeBuffer<RetType>>(&mut self, value: T) -> RetType {
    return value.setAttributeBuffer(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn hasOpenGLShaderPrograms<RetType, T: QOpenGLShaderProgram_hasOpenGLShaderPrograms<RetType>>(&mut self, value: T) -> RetType {
    return value.hasOpenGLShaderPrograms(self);
    // return 1;
  }
}

pub trait QOpenGLShaderProgram_hasOpenGLShaderPrograms<RetType> {
  fn hasOpenGLShaderPrograms(self, rsthis: &mut QOpenGLShaderProgram) -> RetType;
}

// proto: static bool QOpenGLShaderProgram::hasOpenGLShaderPrograms(QOpenGLContext * context);
impl<'a> /*trait*/ QOpenGLShaderProgram_hasOpenGLShaderPrograms<i8> for (&'a mut QOpenGLContext) {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn setPatchVertexCount<RetType, T: QOpenGLShaderProgram_setPatchVertexCount<RetType>>(&mut self, value: T) -> RetType {
    return value.setPatchVertexCount(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn setAttributeArray<RetType, T: QOpenGLShaderProgram_setAttributeArray<RetType>>(&mut self, value: T) -> RetType {
    return value.setAttributeArray(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn bindAttributeLocation<RetType, T: QOpenGLShaderProgram_bindAttributeLocation<RetType>>(&mut self, value: T) -> RetType {
    return value.bindAttributeLocation(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn bind<RetType, T: QOpenGLShaderProgram_bind<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn enableAttributeArray<RetType, T: QOpenGLShaderProgram_enableAttributeArray<RetType>>(&mut self, value: T) -> RetType {
    return value.enableAttributeArray(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn addShader<RetType, T: QOpenGLShaderProgram_addShader<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn attributeLocation<RetType, T: QOpenGLShaderProgram_attributeLocation<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn programId<RetType, T: QOpenGLShaderProgram_programId<RetType>>(&mut self, value: T) -> RetType {
    return value.programId(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn disableAttributeArray<RetType, T: QOpenGLShaderProgram_disableAttributeArray<RetType>>(&mut self, value: T) -> RetType {
    return value.disableAttributeArray(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn uniformLocation<RetType, T: QOpenGLShaderProgram_uniformLocation<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn FreeQOpenGLShaderProgram<RetType, T: QOpenGLShaderProgram_FreeQOpenGLShaderProgram<RetType>>(&mut self, value: T) -> RetType {
    return value.FreeQOpenGLShaderProgram(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn defaultInnerTessellationLevels<RetType, T: QOpenGLShaderProgram_defaultInnerTessellationLevels<RetType>>(&mut self, value: T) -> RetType {
    return value.defaultInnerTessellationLevels(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn link<RetType, T: QOpenGLShaderProgram_link<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn shaders<RetType, T: QOpenGLShaderProgram_shaders<RetType>>(&mut self, value: T) -> RetType {
    return value.shaders(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn defaultOuterTessellationLevels<RetType, T: QOpenGLShaderProgram_defaultOuterTessellationLevels<RetType>>(&mut self, value: T) -> RetType {
    return value.defaultOuterTessellationLevels(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn log<RetType, T: QOpenGLShaderProgram_log<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn patchVertexCount<RetType, T: QOpenGLShaderProgram_patchVertexCount<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn create<RetType, T: QOpenGLShaderProgram_create<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn removeShader<RetType, T: QOpenGLShaderProgram_removeShader<RetType>>(&mut self, value: T) -> RetType {
    return value.removeShader(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn removeAllShaders<RetType, T: QOpenGLShaderProgram_removeAllShaders<RetType>>(&mut self, value: T) -> RetType {
    return value.removeAllShaders(self);
    // return 1;
  }
}
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn maxGeometryOutputVertices<RetType, T: QOpenGLShaderProgram_maxGeometryOutputVertices<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn release<RetType, T: QOpenGLShaderProgram_release<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QOpenGLShaderProgram {
  pub fn metaObject<RetType, T: QOpenGLShaderProgram_metaObject<RetType>>(&mut self, value: T) -> RetType {
