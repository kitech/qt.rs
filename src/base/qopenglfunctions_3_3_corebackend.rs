...
extern {
  // proto: QOpenGLVersionStatus QOpenGLFunctions_3_3_CoreBackend::versionStatus();
  fn _ZN32QOpenGLFunctions_3_3_CoreBackend13versionStatusEv() -> i32;
  // proto: void QOpenGLFunctions_3_3_CoreBackend::NewQOpenGLFunctions_3_3_CoreBackend(QOpenGLContext * context);
  fn _ZN32QOpenGLFunctions_3_3_CoreBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_3_3_CoreBackend {
  pub fn versionStatus<T: QOpenGLFunctions_3_3_CoreBackend_versionStatus>(&mut self, value: T) -> i32 {
    value.versionStatus(self);
    return 1;
  }
}

pub trait QOpenGLFunctions_3_3_CoreBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_3_3_CoreBackend) -> i32;
}
...
// proto: void QOpenGLFunctions_3_3_CoreBackend::NewQOpenGLFunctions_3_3_CoreBackend(QOpenGLContext * context);
impl<'a> /*trait*/ QOpenGLFunctions_3_3_CoreBackend_NewQOpenGLFunctions_3_3_CoreBackend for (&'a mut QOpenGLContext) {
  fn NewQOpenGLFunctions_3_3_CoreBackend(self) -> QOpenGLFunctions_3_3_CoreBackend {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
    ...
    let rsthis = QOpenGLFunctions_3_3_CoreBackend{qclsinst: qthis};
    return rsthis;
    // return 1;
  }
}
