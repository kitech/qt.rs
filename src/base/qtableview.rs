...
impl /*struct*/ QTableView {
  pub fn resizeRowsToContents<RetType, T: QTableView_resizeRowsToContents<RetType>>(&mut self, value: T) -> RetType {
    return value.resizeRowsToContents(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn setRowHeight<RetType, T: QTableView_setRowHeight<RetType>>(&mut self, value: T) -> RetType {
    return value.setRowHeight(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn verticalHeader<RetType, T: QTableView_verticalHeader<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setSpan<RetType, T: QTableView_setSpan<RetType>>(&mut self, value: T) -> RetType {
    return value.setSpan(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn setSortingEnabled<RetType, T: QTableView_setSortingEnabled<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setColumnWidth<RetType, T: QTableView_setColumnWidth<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setWordWrap<RetType, T: QTableView_setWordWrap<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn doItemsLayout<RetType, T: QTableView_doItemsLayout<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setSelectionModel<RetType, T: QTableView_setSelectionModel<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setHorizontalHeader<RetType, T: QTableView_setHorizontalHeader<RetType>>(&mut self, value: T) -> RetType {
    return value.setHorizontalHeader(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn setRowHidden<RetType, T: QTableView_setRowHidden<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn rowViewportPosition<RetType, T: QTableView_rowViewportPosition<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn columnAt<RetType, T: QTableView_columnAt<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn isRowHidden<RetType, T: QTableView_isRowHidden<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn showColumn<RetType, T: QTableView_showColumn<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn resizeRowToContents<RetType, T: QTableView_resizeRowToContents<RetType>>(&mut self, value: T) -> RetType {
    return value.resizeRowToContents(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn setRootIndex<RetType, T: QTableView_setRootIndex<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setColumnHidden<RetType, T: QTableView_setColumnHidden<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn hideRow<RetType, T: QTableView_hideRow<RetType>>(&mut self, value: T) -> RetType {
    return value.hideRow(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn resizeColumnsToContents<RetType, T: QTableView_resizeColumnsToContents<RetType>>(&mut self, value: T) -> RetType {
    return value.resizeColumnsToContents(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn wordWrap<RetType, T: QTableView_wordWrap<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setShowGrid<RetType, T: QTableView_setShowGrid<RetType>>(&mut self, value: T) -> RetType {
    return value.setShowGrid(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn isColumnHidden<RetType, T: QTableView_isColumnHidden<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn selectRow<RetType, T: QTableView_selectRow<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn metaObject<RetType, T: QTableView_metaObject<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn isCornerButtonEnabled<RetType, T: QTableView_isCornerButtonEnabled<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn selectColumn<RetType, T: QTableView_selectColumn<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn FreeQTableView<RetType, T: QTableView_FreeQTableView<RetType>>(&mut self, value: T) -> RetType {
    return value.FreeQTableView(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn resizeColumnToContents<RetType, T: QTableView_resizeColumnToContents<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn sortByColumn<RetType, T: QTableView_sortByColumn<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn columnSpan<RetType, T: QTableView_columnSpan<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn columnWidth<RetType, T: QTableView_columnWidth<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn columnViewportPosition<RetType, T: QTableView_columnViewportPosition<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn rowHeight<RetType, T: QTableView_rowHeight<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn rowAt<RetType, T: QTableView_rowAt<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn rowSpan<RetType, T: QTableView_rowSpan<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn setCornerButtonEnabled<RetType, T: QTableView_setCornerButtonEnabled<RetType>>(&mut self, value: T) -> RetType {
    return value.setCornerButtonEnabled(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn visualRect<RetType, T: QTableView_visualRect<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn indexAt<RetType, T: QTableView_indexAt<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn horizontalHeader<RetType, T: QTableView_horizontalHeader<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn isSortingEnabled<RetType, T: QTableView_isSortingEnabled<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn clearSpans<RetType, T: QTableView_clearSpans<RetType>>(&mut self, value: T) -> RetType {
    return value.clearSpans(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn setVerticalHeader<RetType, T: QTableView_setVerticalHeader<RetType>>(&mut self, value: T) -> RetType {
    return value.setVerticalHeader(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn showGrid<RetType, T: QTableView_showGrid<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QTableView {
  pub fn showRow<RetType, T: QTableView_showRow<RetType>>(&mut self, value: T) -> RetType {
    return value.showRow(self);
    // return 1;
  }
}
...
impl /*struct*/ QTableView {
  pub fn hideColumn<RetType, T: QTableView_hideColumn<RetType>>(&mut self, value: T) -> RetType {
