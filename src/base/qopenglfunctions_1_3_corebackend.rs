...
extern {
  // proto: QOpenGLVersionStatus QOpenGLFunctions_1_3_CoreBackend::versionStatus();
  fn _ZN32QOpenGLFunctions_1_3_CoreBackend13versionStatusEv() -> i32;
  // proto: void QOpenGLFunctions_1_3_CoreBackend::NewQOpenGLFunctions_1_3_CoreBackend(QOpenGLContext * context);
  fn _ZN32QOpenGLFunctions_1_3_CoreBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_1_3_CoreBackend {
  pub fn versionStatus<T: QOpenGLFunctions_1_3_CoreBackend_versionStatus>(&mut self, value: T) -> i32 {
...
pub trait QOpenGLFunctions_1_3_CoreBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_1_3_CoreBackend) -> i32;
}
