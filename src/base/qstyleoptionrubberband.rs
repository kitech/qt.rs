...
extern {
  // proto: void QStyleOptionRubberBand::NewQStyleOptionRubberBand(int version);
  fn _ZN22QStyleOptionRubberBandC1Ei(qthis: *mut c_void, arg0: c_int) -> i32;
  // proto: void QStyleOptionRubberBand::NewQStyleOptionRubberBand();
  fn _ZN22QStyleOptionRubberBandC1Ev(qthis: *mut c_void) -> i32;
  // proto: void QStyleOptionRubberBand::NewQStyleOptionRubberBand(const QStyleOptionRubberBand & other);
  fn _ZN22QStyleOptionRubberBandC1ERKS_(qthis: *mut c_void, arg0: *const c_void) -> i32;
}
...
// proto: void QStyleOptionRubberBand::NewQStyleOptionRubberBand(const QStyleOptionRubberBand & other);
impl<'a> /*trait*/ QStyleOptionRubberBand_NewQStyleOptionRubberBand for (&'a  QStyleOptionRubberBand) {
  fn NewQStyleOptionRubberBand(self) -> QStyleOptionRubberBand {
    let qthis: *mut c_void = unsafe{calloc(1, 32)};
