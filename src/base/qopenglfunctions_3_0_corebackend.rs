...
extern {
  ...
  fn _ZN32QOpenGLFunctions_3_0_CoreBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
  // proto: QOpenGLVersionStatus QOpenGLFunctions_3_0_CoreBackend::versionStatus();
  fn _ZN32QOpenGLFunctions_3_0_CoreBackend13versionStatusEv() -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_3_0_CoreBackend {
  pub fn versionStatus<T: QOpenGLFunctions_3_0_CoreBackend_versionStatus>(&mut self, value: T) -> i32 {
...
pub trait QOpenGLFunctions_3_0_CoreBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_3_0_CoreBackend) -> i32;
}
