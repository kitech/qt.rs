...
extern {
  ...
  fn _ZN38QOpenGLFunctions_1_4_DeprecatedBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
  // proto: QOpenGLVersionStatus QOpenGLFunctions_1_4_DeprecatedBackend::versionStatus();
  fn _ZN38QOpenGLFunctions_1_4_DeprecatedBackend13versionStatusEv() -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_1_4_DeprecatedBackend {
  pub fn versionStatus<T: QOpenGLFunctions_1_4_DeprecatedBackend_versionStatus>(&mut self, value: T) -> i32 {
...
pub trait QOpenGLFunctions_1_4_DeprecatedBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_1_4_DeprecatedBackend) -> i32;
}
