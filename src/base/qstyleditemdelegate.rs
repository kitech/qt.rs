...
impl /*struct*/ QStyledItemDelegate {
  pub fn sizeHint<RetType, T: QStyledItemDelegate_sizeHint<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn createEditor<RetType, T: QStyledItemDelegate_createEditor<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn FreeQStyledItemDelegate<RetType, T: QStyledItemDelegate_FreeQStyledItemDelegate<RetType>>(&mut self, value: T) -> RetType {
    return value.FreeQStyledItemDelegate(self);
    // return 1;
  }
}
...
impl /*struct*/ QStyledItemDelegate {
  pub fn updateEditorGeometry<RetType, T: QStyledItemDelegate_updateEditorGeometry<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn setEditorData<RetType, T: QStyledItemDelegate_setEditorData<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn setItemEditorFactory<RetType, T: QStyledItemDelegate_setItemEditorFactory<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn paint<RetType, T: QStyledItemDelegate_paint<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn itemEditorFactory<RetType, T: QStyledItemDelegate_itemEditorFactory<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn displayText<RetType, T: QStyledItemDelegate_displayText<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QStyledItemDelegate {
  pub fn metaObject<RetType, T: QStyledItemDelegate_metaObject<RetType>>(&mut self, value: T) -> RetType {
