...
impl /*struct*/ QOpenGLFunctions_1_0_DeprecatedBackend {
  pub fn versionStatus<RetType, T: QOpenGLFunctions_1_0_DeprecatedBackend_versionStatus<RetType>>(&mut self, value: T) -> RetType {
    return value.versionStatus(self);
    // return 1;
  }
}

pub trait QOpenGLFunctions_1_0_DeprecatedBackend_versionStatus<RetType> {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_1_0_DeprecatedBackend) -> RetType;
}

// proto: static QOpenGLVersionStatus QOpenGLFunctions_1_0_DeprecatedBackend::versionStatus();
impl<'a> /*trait*/ QOpenGLFunctions_1_0_DeprecatedBackend_versionStatus<()> for () {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_1_0_DeprecatedBackend) -> () {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
