...
impl /*struct*/ QStyleOption {
  pub fn FreeQStyleOption<T: QStyleOption_FreeQStyleOption>(&mut self, value: T)  {
...
impl /*struct*/ QStyleOption {
  pub fn init<T: QStyleOption_init>(&mut self, value: T)  {
     value.init(self);
    // return 1;
  }
}
...
impl /*struct*/ QStyleOption {
  pub fn initFrom<T: QStyleOption_initFrom>(&mut self, value: T)  {
     value.initFrom(self);
    // return 1;
  }
}
