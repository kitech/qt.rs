...
extern {
  ...
  fn _ZN38QOpenGLFunctions_2_0_DeprecatedBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
  // proto: QOpenGLVersionStatus QOpenGLFunctions_2_0_DeprecatedBackend::versionStatus();
  fn _ZN38QOpenGLFunctions_2_0_DeprecatedBackend13versionStatusEv() -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_2_0_DeprecatedBackend {
  pub fn versionStatus<T: QOpenGLFunctions_2_0_DeprecatedBackend_versionStatus>(&mut self, value: T) -> i32 {
    value.versionStatus(self);
    return 1;
  }
}

pub trait QOpenGLFunctions_2_0_DeprecatedBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_2_0_DeprecatedBackend) -> i32;
}
