...
extern {
  // proto: void QOpenGLFunctions_1_1_CoreBackend::NewQOpenGLFunctions_1_1_CoreBackend(QOpenGLContext * context);
  fn _ZN32QOpenGLFunctions_1_1_CoreBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
  // proto: QOpenGLVersionStatus QOpenGLFunctions_1_1_CoreBackend::versionStatus();
  fn _ZN32QOpenGLFunctions_1_1_CoreBackend13versionStatusEv() -> i32;
}
...
// proto: void QOpenGLFunctions_1_1_CoreBackend::NewQOpenGLFunctions_1_1_CoreBackend(QOpenGLContext * context);
impl<'a> /*trait*/ QOpenGLFunctions_1_1_CoreBackend_NewQOpenGLFunctions_1_1_CoreBackend for (&'a mut QOpenGLContext) {
  fn NewQOpenGLFunctions_1_1_CoreBackend(self) -> QOpenGLFunctions_1_1_CoreBackend {
...
impl /*struct*/ QOpenGLFunctions_1_1_CoreBackend {
  pub fn versionStatus<T: QOpenGLFunctions_1_1_CoreBackend_versionStatus>(&mut self, value: T) -> i32 {
    value.versionStatus(self);
    return 1;
  }
}

pub trait QOpenGLFunctions_1_1_CoreBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_1_1_CoreBackend) -> i32;
}

// proto: QOpenGLVersionStatus QOpenGLFunctions_1_1_CoreBackend::versionStatus();
impl<'a> /*trait*/ QOpenGLFunctions_1_1_CoreBackend_versionStatus for () {
  fn versionStatus(self, this: &mut QOpenGLFunctions_1_1_CoreBackend) -> i32 {
    // let qthis: *mut c_void = unsafe{calloc(1, 32)};
