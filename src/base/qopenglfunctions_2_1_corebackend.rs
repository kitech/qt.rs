...
extern {
  ...
  fn _ZN32QOpenGLFunctions_2_1_CoreBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
  // proto: QOpenGLVersionStatus QOpenGLFunctions_2_1_CoreBackend::versionStatus();
  fn _ZN32QOpenGLFunctions_2_1_CoreBackend13versionStatusEv() -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_2_1_CoreBackend {
  pub fn versionStatus<T: QOpenGLFunctions_2_1_CoreBackend_versionStatus>(&mut self, value: T) -> i32 {
...
pub trait QOpenGLFunctions_2_1_CoreBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_2_1_CoreBackend) -> i32;
}
