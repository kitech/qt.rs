...
impl /*struct*/ QOpenGLFunctions_2_1_CoreBackend {
  pub fn versionStatus<RetType, T: QOpenGLFunctions_2_1_CoreBackend_versionStatus<RetType>>(&mut self, value: T) -> RetType {
    return value.versionStatus(self);
    // return 1;
  }
}

pub trait QOpenGLFunctions_2_1_CoreBackend_versionStatus<RetType> {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_2_1_CoreBackend) -> RetType;
}
