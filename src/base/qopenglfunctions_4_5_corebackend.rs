...
impl /*struct*/ QOpenGLFunctions_4_5_CoreBackend {
  pub fn versionStatus<RetType, T: QOpenGLFunctions_4_5_CoreBackend_versionStatus<RetType>>(&mut self, value: T) -> RetType {
    return value.versionStatus(self);
    // return 1;
  }
}

pub trait QOpenGLFunctions_4_5_CoreBackend_versionStatus<RetType> {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_4_5_CoreBackend) -> RetType;
}

// proto: static QOpenGLVersionStatus QOpenGLFunctions_4_5_CoreBackend::versionStatus();
impl<'a> /*trait*/ QOpenGLFunctions_4_5_CoreBackend_versionStatus<()> for () {
  fn versionStatus(self, rsthis: &mut QOpenGLFunctions_4_5_CoreBackend) -> () {
