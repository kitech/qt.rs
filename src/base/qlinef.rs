...
impl /*struct*/ QLineF {
  pub fn translate<RetType, T: QLineF_translate<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn setPoints<RetType, T: QLineF_setPoints<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn setP2<RetType, T: QLineF_setP2<RetType>>(&mut self, value: T) -> RetType {
    return value.setP2(self);
    // return 1;
  }
}
...
impl /*struct*/ QLineF {
  pub fn translated<RetType, T: QLineF_translated<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn setLength<RetType, T: QLineF_setLength<RetType>>(&mut self, value: T) -> RetType {
    return value.setLength(self);
    // return 1;
  }
}
...
impl /*struct*/ QLineF {
  pub fn x1<RetType, T: QLineF_x1<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn angle<RetType, T: QLineF_angle<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn length<RetType, T: QLineF_length<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn setAngle<RetType, T: QLineF_setAngle<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn x2<RetType, T: QLineF_x2<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn dx<RetType, T: QLineF_dx<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn p1<RetType, T: QLineF_p1<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn normalVector<RetType, T: QLineF_normalVector<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn toLine<RetType, T: QLineF_toLine<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn pointAt<RetType, T: QLineF_pointAt<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn p2<RetType, T: QLineF_p2<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn y2<RetType, T: QLineF_y2<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn dy<RetType, T: QLineF_dy<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn unitVector<RetType, T: QLineF_unitVector<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn isNull<RetType, T: QLineF_isNull<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn y1<RetType, T: QLineF_y1<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn angleTo<RetType, T: QLineF_angleTo<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn setLine<RetType, T: QLineF_setLine<RetType>>(&mut self, value: T) -> RetType {
...
impl /*struct*/ QLineF {
  pub fn fromPolar<RetType, T: QLineF_fromPolar<RetType>>(&mut self, value: T) -> RetType {
    return value.fromPolar(self);
    // return 1;
  }
}

pub trait QLineF_fromPolar<RetType> {
  fn fromPolar(self, rsthis: &mut QLineF) -> RetType;
}

// proto: static QLineF QLineF::fromPolar(qreal length, qreal angle);
impl<'a> /*trait*/ QLineF_fromPolar<QLineF> for (f64, f64) {
...
impl /*struct*/ QLineF {
  pub fn setP1<RetType, T: QLineF_setP1<RetType>>(&mut self, value: T) -> RetType {
    return value.setP1(self);
    // return 1;
  }
}
