...
extern {
  // proto: QOpenGLVersionStatus QOpenGLFunctions_1_3_DeprecatedBackend::versionStatus();
  fn _ZN38QOpenGLFunctions_1_3_DeprecatedBackend13versionStatusEv() -> i32;
  // proto: void QOpenGLFunctions_1_3_DeprecatedBackend::NewQOpenGLFunctions_1_3_DeprecatedBackend(QOpenGLContext * context);
  fn _ZN38QOpenGLFunctions_1_3_DeprecatedBackendC1EP14QOpenGLContext(qthis: *mut c_void, arg0: *mut c_void) -> i32;
}
...
impl /*struct*/ QOpenGLFunctions_1_3_DeprecatedBackend {
  pub fn versionStatus<T: QOpenGLFunctions_1_3_DeprecatedBackend_versionStatus>(&mut self, value: T) -> i32 {
...
pub trait QOpenGLFunctions_1_3_DeprecatedBackend_versionStatus {
  fn versionStatus(self, this: &mut QOpenGLFunctions_1_3_DeprecatedBackend) -> i32;
}
